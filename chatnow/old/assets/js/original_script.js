$(document).ready(function() {
	...
	var mybot = '<div class="chatCont" id="chatCont">'+
					...
					'<div class="chatForm" id="chat-div">'+
						...
						'</div>'+
						'<input type="text" id="chat-input" autocomplete="off" placeholder="Try typing here"'+ 
	...
	function setBotResponse(val) {
		setTimeout(function(){
			/* if($.trim(val) == '') {
				...
				var BotResponse = '<img src="https://annextrades.com/assets/images/annexis-emblem.png" style="float: left; width: 40px; border-radius: 30px;"><p style="margin-left: 20px;" class="botResult">'+val+'</p><div class="clearfix"></div>';
				$(BotResponse).appendTo('#result_div');
			/* } */
	...
	function setUserResponse(val) {
		var UserResponse = '<img src="https://annextrades.com/assets/images/annexis-emblem.png" style="float: right; width: 40px; border-radius: 30px;"><p style="margin-right: 20px;" class="userEnteredText">'+val+'</p><div class="clearfix"></div>';
