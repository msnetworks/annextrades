<div class="col-lg-3 col-md-4 col-6 remove-padding">
		<a class="item" href="{{ route('front.product', $prod->slug) }}">
			@foreach(DB::table('verifications')->where(['user_id' => $prod->user_id])->get() as $data)
				@if ($data)
					<img class="img-flag" src="{{ asset('assets/images/flag/verifiedsheld.png') }}" alt="Verified Seller">
				@endif
			@endforeach
			<div class="item-img">
			...
			<div class="info">
				...
				<img class="img-flag1" src="{{ asset('assets/images/flag/ind.png') }}" alt="Verified Seller">
