<li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="menu2" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-product-update') }}"><span>{{ __('Product Update') }}</span></a>
            </li>
        </ul>
    </li>
    <li>
        <a href="#pr2" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="icofont-cart"></i>{{ __('Post Requirement') }}
        </a>
        <ul class="collapse list-unstyled" id="pr2" data-parent="#accordion">
            <li>
                <a href="{{ route('admin-post-requirement') }}"><span>{{ __('All Requests') }}</span></a>
            </li>
        </ul>
    </li>
    <li>
        <a href="#prus" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="icofont-cart"></i>{{ __('Government Contracts') }}
        </a>
        <ul class="collapse list-unstyled" id="prus" data-parent="#accordion">
            <li>
                <a href="{{ route('admin-government-contracts') }}"><span>{{ __('All Requests') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-government-contract-import') }}"><span>{{ __('Import') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-cat-us-index') }}"><span>{{ __('All Categories') }}</span></a>
            </li>
