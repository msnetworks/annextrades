					...
					<div class="user-profile-details">
						<div class="order-history">
							<div class="header-area">
								<h4 class="title">
									Post Requirement{{--  <a data-toggle="modal" data-target="#vendorform" class="mybtn1" href="javascript:;"> <i class="fas fa-envelope"></i> {{ $langg->lang377 }}</a> --}}
								</h4>
							</div>
                                        ...
                                        <tbody>
                                            ...
                                            if ($conv->photo!="") {
                                                if ($ext == 'png' || $ext == 'PNG' || $ext == 'jpg' || $ext == 'jpeg' || $ext == 'jifi' || $ext == 'JPG' || $ext == 'JPEG' || $ext == 'JIFI') {
                                                    ...
                                                    <div class='row'>
                                                        <div class='col-md-12'>
                                                            <img class='border' src='".asset('assets/images/postrequest/')."/".$conv->photo ."' alt='Title'> </br>
                                                        </div>
                                                    </div>
                                                    </div>
                                                ";
                                            ...
                                            if($conv->photo1!="")
                                            {
                                                if ($ext1 == 'png' || $ext1 == 'PNG' || $ext1 == 'jpg' || $ext1 == 'jpeg' || $ext1 == 'jifi' || $ext1 == 'JPG' || $ext1 == 'JPEG' || $ext1 == 'JIFI') {
                                                    $photo1 = "<div class='col-md-4 d-flex justify-content-center pd-15' style='padding-bottom: 30px;'>
                                                        <div class='row'>
                                                            <div class='col-md-12'>
                                                                <img class='border' src='".asset('assets/images/postrequest/')."/".$conv->photo1 ."' alt='Title'> </br>
                                                            </div>
                                                        </div>
                                                    </div>";
                                                }else{
                                            ...
                                            if($conv->photo2!=""){
                                                if ($ext2 == 'png' || $ext3 == 'PNG' || $ext2 == 'jpg' || $ext2 == 'jpeg' || $ext2 == 'jifi' || $ext2 == 'JPG' || $ext2 == 'JPEG' || $ext2 == 'JIFI') {
                                                    $photo2 = "<div class='col-md-4 d-flex justify-content-center pd-15' style='padding-bottom: 30px;'>
                                                        <div class='row'>
                                                            <div class='col-md-12'>
                                                                <img class='border' src='".asset('assets/images/postrequest/')."/".$conv->photo2 ."' alt='Title'> </br>
                                                            </div>
                                                        </div>
                                                    </div>";
                                                }else{
                                            ...
                                            if($conv->photo3!="") {
                                                if ($ext3 == 'png' || $ext3 == 'PNG' || $ext3 == 'jpg' || $ext3 == 'jpeg' || $ext3 == 'jifi' || $ext3 == 'JPG' || $ext3 == 'JPEG' || $ext3 == 'JIFI') {
                                                    $photo3 = "<div class='col-md-4 d-flex justify-content-center pd-15' style='padding-bottom: 30px;'>
                                                        <div class='row'>
                                                            <div class='col-md-12'><img class='border' src='".asset('assets/images/postrequest/')."/".$conv->photo3 ."' alt='Title'> </br></div>
                                                        </div>
                                                    </div> ";
                                                }else{
                                                    $photo3 = "<div class='col-md-4 d-flex justify-content-center pd-15' style='padding-bottom: 30px;'>
                                             ...
                                             if($conv->photo4!=""){
                                                if ($ext4 == 'png' || $ext4 == 'PNG' || $ext4 == 'jpg' || $ext4 == 'jpeg' || $ext4 == 'jifi' || $ext4 == 'JPG' || $ext4 == 'JPEG' || $ext4 == 'JIFI') {
                                                    ...
                                                    $photo4 = "<div class='col-md-4 d-flex justify-content-center pd-15' style='padding-bottom: 30px;'>
                                                        <div class='row'>
                                                            <div class='col-md-12'><img class='border' src='".asset('assets/images/postrequest/')."/".$conv->photo4 ."' alt='Title'> </br></div>
                                                        </div>
                                                    </div>";
                                                }else{
                                                    $photo4 = "<div class='col-md-4 d-flex justify-content-center pd-15' style='padding-bottom: 30px;'>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('user-postrequest-edit', $conv->id) }}" class="btn btn-primary" ><i class="fa fa-edit"></i></a>
                                                </td>
                                                <td class="text-center"><a class="text-center count_quote btn btn-primary" href="{{ route('user-postrequest-quote', $conv->request_id) }}">{{ $count }}</a></td>
                                                </tr>
                                                @php
                                                    $i++;
                                                @endphp
