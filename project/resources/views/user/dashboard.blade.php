      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          @include('includes.form-success')
            {{-- @if($gs->reg_vendor ==1 & Auth::user()->is_vendor != 2)
              <div class="login-area signup-area pd-15">
                <div class="header-area text-left mb-0">
                  <div class="title">STEP 3 - SELECT PLAN &nbsp;&nbsp;&nbsp;
                    <a href="{{ route('user-package') }}" class="mybtn4 lg">
                      {{ Auth::user()->is_vendor == 1 ? $langg->lang1003 : (Auth::user()->is_vendor == 0 ? $langg->lang1003 : $langg->lang1003) }}
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div class="login-area signup-area pd-15">
                <div class="header-area text-left mb-0">
                  <div class="title">STEP 4 - &nbsp;
                    <a href="{{ route('vendor-prod-types') }}" class="mybtn4 lg">
