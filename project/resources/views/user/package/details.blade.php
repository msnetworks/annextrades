...
<div class="account-info">
                            <div class="header-area">
                                @if(Session::get('country') == 'US')
								<h4 class="title">
                                    {{ $langg->lang409 }} <a class="mybtn1" href="{{route('front.pricing-us')}}"> <i class="fas fa-arrow-left"></i> {{ $langg->lang410 }}</a>
                                </h4>
                                @else
                                <h4 class="title">
                                    {{ $langg->lang409 }} <a class="mybtn1" href="{{route('front.pricing')}}"> <i class="fas fa-arrow-left"></i> {{ $langg->lang410 }}</a>
                                </h4>
                                @endif
                            </div>
                            ...
                            {{ csrf_field() }}
                                ...
                                @if($user->is_vendor == 0)
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text"  id="shop-name" class="option" name="shop_name" placeholder="{{ $langg->lang238 }}" value="{{ Auth::user()->shop_name }}"  required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                    <input type="text" class="option" name="owner_name" value="{{ Auth::user()->owner_name }}"  placeholder="{{ $langg->lang239 }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" class="option" name="shop_number" value="{{ Auth::user()->shop_number }}"  placeholder="{{ $langg->lang240 }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" class="option" name="shop_address" value="{{ Auth::user()->shop_address }}"  placeholder="{{ $langg->lang241 }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                    <input type="text" class="option" name="reg_number" value="{{ Auth::user()->reg_number }}"  placeholder="{{ $langg->lang242 }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <textarea class="option" name="shop_message" placeholder="{{ $langg->lang243 }}" rows="5">{!! Auth::user()->shop_message !!}</textarea>
                                            </div>
                                        </div>
                                 ...
                                 @if($subs->price != 0)       
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 text-center">
                                            ...
                                            @if($gs->is_razorpay == 1)
                                            <input type="radio" id="razorpay" onchange="meThods(this)" name="method" value="Razorpay" required><label for="razorpay" required><img src="https://annextrades.com/assets/images/Razorpay.png" width="300px" alt="Razorpay"></label><br><br>
                                            @endif
                                            
                                            @if($gs->stripe_check == 1)
                                            <input type="radio" id="stripe" onchange="meThods(this)" name="method" value="Stripe" required><label for="stripe" required><img src="https://annextrades.com/assets/images/logo-stripe.png" width="300px" alt="Authorize"></label>
                                            @endif
                                            {{-- <select name="method" id="option" onchange="meThods(this)" class="option" required="">
                                                ...
                                                @endif
                                                @if($gs->stripe_check == 1)
                                                    <option value="Stripe">{{ $langg->lang421 }} <img src="{{ asset('assets/images/logo-stripe.png') }}" width="100%" alt="Razorpay"></option>
                                                @endif
                                                ...
                                                @endif
                                                @if($gs->is_razorpay == 1)
                                                    <option selected value="Razorpay">{{ $langg->razorpay }} <img src="{{ asset('assets/images/Razorpay.png') }}" width="100%" alt="Razorpay"></option>
                                                @endif
                                                @if($gs->is_authorize == 1)
                                                    <option value="Authorize.Net">{{ $langg->lang809 }} <img src="{{ asset('assets/images/Authorize.png') }}" width="100%" alt="Authorize.Net"></option>
                                                @endif
                                                @if($gs->is_mercado == 1)
                                    ...
                                    <div id="stripes" style="display: none;"> <br>
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <h5 class="title pt-1">
                                                    {{ $langg->lang422 }} *
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                            <button type="submit" id="final-btn" class="mybtn1"><!-- {{ $langg->lang426 }} --> PAY NOW</button>
                                    </div>
                                </div>
