					...
					<div class="content">
						...
						<div class="right-content">
							<div class="list">
								<ul>
									<li>
										<a target="_blank" class="whatsapp-text cnt-btn" href="https://wa.me/+17723070151"><i class="fa fa-whatsapp"></i> CONTACT US</a>
									</li>
					...
					<nav hidden>
						...
						<ul class="menu">
							...
							<li>
								...
								@else
									<button class="mybtn3" onclick="alert('Please Login to Post a Requirement.')">{{ $langg->lang1001 }}</button>
								@endif
							</li>
						</ul>
                        ...
                        <form class="mregisterform" action="{{route('user-register-submit')}}" method="POST">
                          ...
                          <div class="row">
                           ...
                           <div class="col-lg-6">
							...
							<div class="form-input">
								<select name="reg_name" class="User Name">
									<option value="Product"><i class="icofont-ui-cart"></i>Product</option>
									<option value="Service"><i class="icofont-ui-cart"></i>Service</option>
								</select>
