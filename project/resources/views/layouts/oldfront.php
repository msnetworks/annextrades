					...
					<div class="content">
						<div class="left-content">
							<div class="list">
								...
								<span>{{ Session::has('currency') ?   DB::table('currencies')->where('id','=',Session::get('currency'))->first()->sign   : DB::table('currencies')->where('is_default','=',1)->first()->sign }}</span>
									...
									@endif --}}
									<li>
										<a target="_blank" href="https://annextrades.com/chatnow">
											<div style="color: #fff; font-weight: 500; font-size: 14px; padding: 0px 9px;">
												HOW IT WORKS
											</div>
										</a>
									</li>
						...
						<div class="right-content">
							<div class="list">
								<ul>
									<li>
										<a target="_blank" class="whatsapp-text cnt-btn" href="https://wa.me/+17723070151"><i class="fa fa-whatsapp"> CONTACT US</i></a>
									</li>
				...
				<div class="col-lg-2 col-sm-6 col-5 remove-padding">
					<div class="logo">
						<a href="{{ route('front.index') }}">
							<img style="margin: 13px;" src="{{asset('assets/images/'.$gs->logo)}}" alt="">
						</a>
					</div>
				</div>
				...
				<div class="col-lg-9 col-md-6 mainmenu-wrapper remove-padding">
					<nav hidden>
						...
						<ul class="menu">
							...
							<li>
								<a href="javascript:;" data-toggle="modal" data-target="#post-req-modal" class="track-btn"><button class="mybtn3">{{ $langg->lang1001 }}</button></a>
							</li>
						</ul>
	...
	<div class="modal fade" id="post-req-modal" tabindex="-1" role="dialog" aria-labelledby="post-req-modal" aria-hidden="true">
		<div class="modal-dialog  modal-lg" role="document">
			<div class="modal-content"> 
				<div class="modal-header">
					<div class="container">
						<h6 class="modal-title"> <b>{{ $langg->lang1001 }}</b> </h6>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
				...
				<div class="modal-body">
					<div class="container">
						<div class="order-tracking-content">
							<form id="geniusformdata" action="{{route('post-request-insert')}}" method="POST" enctype="multipart/form-data">
								<div class="row">
								...
								<!-- Create Post Form -->
									...
									<div class="form-group col-12"> 
										<input type="text" name="product_name" class="form-control" id="productname" placeholder="{{ __('Product Name*') }}" required="">
									</div>
									<div class="form-group col-12">
									...
									<div class="form-group col-12">
										<textarea name="product_des" class="form-control" id="describe" placeholder="{{ __('Please include product name, order quantity, usage, special requests if any in your inquiry.') }}" cols="30" rows="3"></textarea>
									</div>
									{{-- <div class="form-group col-6">
										<input type="number" name="quantity" class="form-control" id="quantity" min="1" placeholder="{{ __('Quantity*') }}" required="">
									</div> --}}
									<div class="form-group col-6">
										<select name="order_value" name="order_value" id="ordervalue" class="form-control">
											<option value="">Select Approximate order value</option>
											...
											<option value="10000001">More than 1M</option>
										</select>
									</div>
									<div class="form-group col-6">
										<select name="order_unit" id="orderunit" class="form-control">
											...
											<option value="20 feet Container">20' Container</option>
											<option value="40 feet Container">40' Container</option>
									...
									<div class="form-group col-6">
										<input type="text" name="name" class="form-control" id="name" placeholder="{{ __('Full Name*') }}" required="">
									</div>
									<div class="form-group col-6">
										<input type="text" name="phone" class="form-control" id="phone" placeholder="{{ __('Phone Number*') }}" required="">
									</div>
									<div class="form-group col-12">
