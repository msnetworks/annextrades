                        ...
                        <div class="row">
                            <!-- /resources/views/post/create.blade.php -->
                                ...
                                <div class="form-input col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                    ...
                                    <textarea name="product_des" class="form-control nic-edit-p" id="describe" placeholder="{{ __('Quantity, specification, sizes, timeline, delivery location, price range.') }}" cols="30" rows="7"></textarea> <br>
                                </div>
                                <div class="form-input col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12"></div>
...
<script type="text/javascript">
    ...
    $("#addRow").click(function () {
            ...
            var showId = $("#geniusformdata :file").length;
            if(showId <= 4)
            {
                var html = '';
