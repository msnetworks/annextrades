...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
					...
					<input type="hidden" id="headerdata" value="{{ __("EDIT YOUR REQUIREMENTS") }}"> 
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ __("Edit Post") }}</h4>
										<ul class="links">
											<li>
                                            ...
                                            <div class="col-lg-12 border" style="padding: 15px;">
                                                <div class="container">
                                                    <div class="row">
                                                        ...
                                                        <form id="postdata" action="{{route('admin-postrequest-update')}}" method="POST" enctype="multipart/form-data">
                                                            <div class="row">
                                                                <!-- /resources/views/post/create.blade.php -->
                                                                    ...
                                                                    <div class="form-input col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12"> 
                                                                        ...
                                                                        <select class="form-control select2" name="cover_image_category" id="cover_image_category">
                                                                            ...
                                                                            <option value="<?= $category->id; ?>" <?= ($category->id == $data[0]->cover_image_category) ? 'selected' : ''; ?>><?= $category->name; ?></option>
                                                                            <?php endforeach; ?>
                                                                        </select>
                                                                    </div>
                                                                    <div class="form-input col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12"></div>
                                                                    ...
                                                                    <div class="form-input col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12"> 
                                                                        ...
                                                                        <input type="radio" name="pri_gov" id="private" value="1" @if ($data[0]->pri_gov == '1') checked @endif> &nbsp;&nbsp;
                                                                        <label for="government"> Government</label>
                                                                        <input type="radio" name="pri_gov" id="government" value="0"  @if ($data[0]->pri_gov == '0') checked @endif></br></br>
                                                                    </div>
                                                                    <div class="form-input col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12"></div>
                                                                    ...
                                                                    <div class="form-input col-xl-12 col-lg-6 col-md-12 col-sm-12 col-12">
                                                                        ...
                                                                        <textarea name="short_des" class="form-control" placeholder="{{ __('Short description about product..') }}" cols="30" rows="7">{!! $data[0]->short_des !!}</textarea> <br>
                                                                    </div>
                                                                    <div class="form-input col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                                        ...
                                                                        <textarea name="product_des" class="form-control" id="describe" placeholder="{{ __('Quantity, specification, sizes, timeline, delivery location, price range.') }}" cols="30" rows="7">{!! $data[0]->product_des !!}</textarea> <br>
                                                                        <script>
                                                                    ...
                                                                    <div class="form-input col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                                                        ...
                                                                        <input type="text" class="form-control" name="price_from" id="*price-min" value="{{ $data[0]->price_from }}" placeholder="e.g. $10 - $15 or N/A">
                                                                    ...
                                                                    <div class="form-input col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                                                        ...
                                                                        <input type="datetime-local" name="deadline" class="form-control" id="deadline" value="{{ date('Y-m-d\TH:i', strtotime($data[0]->deadline)) }}" required=""> </br>
