                      ...
                      <form id="geniusformdata" action="{{route('admin-subscription-create')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="showbox" id="limits">
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="number" min="0" class="input-field" id="allowed_products" name="allowed_products" placeholder="{{ __("Enter Allowed Products") }}" value="1">
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="left-area">
                                  <h4 class="heading">{{ __("Allowed Deals") }} *</h4>
                              </div>
                            </div>
                            <div class="col-lg-7">
                              <input type="number" min="0" class="input-field" id="allowed_deals" name="allowed_deals" placeholder="{{ __("Enter Allowed Deals Post") }}" value="1">
                            </div>
                          </div>
                        </div>
