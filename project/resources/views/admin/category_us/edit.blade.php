                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-cat-us-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Display Name') }} *</h4>
                                <p class="sub-heading">{{ __('(In Any Language)') }}</p>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="display_name" placeholder="{{ __('Enter Display Name') }}" required="" value="{{$data->display_name}}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Refine') }} *</h4>
                                <p class="sub-heading">{{ __('(In English)') }}</p>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            @if($data->is_refine)
                              <input type="radio" name="is_refine" value="1" checked>&nbsp;Yes
                              <input type="radio" name="is_refine" value="0">&nbsp;No
                            @else
                              <input type="radio" name="is_refine" value="1">&nbsp;Yes
                              <input type="radio" name="is_refine" value="0" checked>&nbsp;No
                            @endif
                          </div>
                        </div>
