									...
									<div class="col-lg-12">
										<div class="product-description">
											...
											<div class="text-right">
												@php
													$chk = DB::table('products')->where('id', $data->id-1)->get();
												@endphp
												@if (count($chk))
												<a href="{{ route('admin-prod-edit',$data->id-1) }}"><button class="btn btn-primary">PREV PRODUCT</button></a>
												@endif
												&nbsp;&nbsp;
												@php
													$chk = DB::table('products')->where('id', $data->id+1)->get();
												@endphp
												@if (count($chk))
													<a href="{{ route('admin-prod-edit',$data->id+1) }}"><button class="btn btn-primary">NEXT PRODUCT</button></a></div>
												@endif
				...
				<i class="icofont-upload-alt"></i> {{ __('Upload Image Here') }}
											...
											<div class="#{{ $data->measure == null ? 'showbox' : '' }}">
												...
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading">{{ __('Product Unit') }}*</h4>
														</div>
													</div>
													<div class="col-lg-7">
														...
														<select id="product_measure" name="measure">
															...
															<option value="Bag/Bags" {{$data->measure == 'Bag/Bags' ? 'selected':''}}>Bag/Bags</option>
															<option value="Barrel/Barrels" {{$data->measure == 'Barrel/Barrels' ? 'selected':''}}>Barrel/Barrels</option>
															<option value="Cubic Meter" {{$data->measure == 'Cubic Meter' ? 'selected':''}}>Cubic Meter</option>
															<option value="Dozen" {{$data->measure == 'Dozen' ? 'selected':''}}>Dozen</option>
															<option value="Gallon" {{$data->measure == 'Gallon' ? 'selected':''}}>Gallon</option>
															...
															<option value="Long Ton" {{$data->measure == 'Long Ton' ? 'selected':''}}>Long Ton</option>
															<option value="Mertic Ton" {{$data->measure == 'Mertic Ton' ? 'selected':''}}>Mertic Ton</option>
															<option value="Ounce" {{$data->measure == 'Ounce' ? 'selected':''}}>Ounce</option>
															<option value="Pair" {{$data->measure == 'Pair' ? 'selected':''}}>Pair</option>
															<option value="Pack/Packs" {{$data->measure == 'Pack/Packs' ? 'selected':''}}>Pack/Packs</option>
															<option value="Piece/Pieces" {{$data->measure == 'Piece/Pieces' ? 'selected':''}}>Piece/Pieces</option>
															<option value="Pound" {{$data->measure == 'Pound' ? 'selected':''}}>Pound</option>
															<option value="Set/Sets" {{$data->measure == 'Set/Sets' ? 'selected':''}}>Set/Sets</option>
															<option value="Short Ton" {{$data->measure == 'Short Ton' ? 'selected':''}}>Short Ton</option>
										...
										<div class="text-right"><a href="{{ route('admin-prod-edit',$data->id-1) }}"><button class="btn btn-primary">PREV PRODUCT</button></a>&nbsp;&nbsp;<a href="{{ route('admin-prod-edit',$data->id+1) }}"><button class="btn btn-primary">NEXT PRODUCT</button></a></div>
									</div>
								</div>
							</div>
						</div>
