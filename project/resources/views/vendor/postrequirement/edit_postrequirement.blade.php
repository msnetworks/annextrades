                    ...
                    <div class="order-history col-lg-12 border" style="padding: 15px;">
                        <div class="container">
                            ...
                            @if(session()->has('success'))
                                ...
                                <form id="postdata" action="{{route('vendor-postrequest-update')}}" method="POST" enctype="multipart/form-data">
                                    <div class="row">
                                                ...
                                                @php
                                                    ...
                                                    if ($ext == 'png' || $ext == 'jpg' || $ext == 'jpeg' || $ext == 'jifi') {
                                                        $photo = "<div class='col-md-4 d-flex justify-content-center pd-15' style='padding-bottom: 30px;'>
                                                            <div class='row'>
                                                                <div class='col-md-12'>
                                                                    <img class='border w-100' src='".asset('assets/images/postrequest/')."/".$data[0]->photo ."' alt='Title'> </br>
                                                                </div>
                                                                <div class='col-md-12'>
                                                    ...
                                                    if($data[0]->photo1!="")
                                                    {
                                                        if ($ext1 == 'png' || $ext1 == 'jpg' || $ext1 == 'jpeg' || $ext1 == 'jifi') {
                                                            $photo = "<div class='col-md-4 d-flex justify-content-center pd-15' style='padding-bottom: 30px;'>
                                                                <div class='row'>
                                                                    <div class='col-md-12'>
                                                                        <img class='border w-100' src='".asset('assets/images/postrequest/')."/".$data[0]->photo1 ."' alt='Title'> </br>
                                                                    </div>
                                                                    <div class='col-md-12'>
                                                    ...
                                                    if($data[0]->photo2!="")
                                                    {
                                                        if ($ext2 == 'png' || $ext2 == 'jpg' || $ext2 == 'jpeg' || $ext2 == 'jifi') {
                                                            $photo2 = "<div class='col-md-4 d-flex justify-content-center pd-15' style='padding-bottom: 30px;'>
                                                                <div class='row'>
                                                                    <div class='col-md-12'>
                                                                        <img class='border w-100' src='".asset('assets/images/postrequest/')."/".$data[0]->photo2 ."' alt='Title'> </br>
                                                                    </div>
                                                                    <div class='col-md-12'>
                                                    ...
                                                    if($data[0]->photo3!="")
                                                    {
                                                        if ($ext3 == 'png' || $ext3 == 'jpg' || $ext3 == 'jpeg' || $ext3 == 'jifi') {
                                                            $photo3 = "<div class='col-md-4 d-flex justify-content-center pd-15' style='padding-bottom: 30px;'>
                                                                <div class='row'>
                                                                    <div class='col-md-12'>
                                                                        <img class='border w-100' src='".asset('assets/images/postrequest/')."/".$data[0]->photo3 ."' alt='Title'> </br>
                                                                    </div>
                                                                    <div class='col-md-12'>
                                                    ...
                                                    if($data[0]->photo4!="")
                                                    {
                                                        if ($ext4 == 'png' || $ext4 == 'jpg' || $ext4 == 'jpeg' || $ext4 == 'jifi') {
                                                            $photo4 = "<div class='col-md-4 d-flex justify-content-center pd-15' style='padding-bottom: 30px;'>
                                                                <div class='row'>
                                                                    <div class='col-md-12'>
                                                                        <img class='border w-100' src='".asset('assets/images/postrequest/')."/".$data[0]->photo4 ."' alt='Title'> </br>
                                                                    </div>
                                                                    <div class='col-md-12'>
