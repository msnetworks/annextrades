...
<div class="content-area">
  <div class="mr-breadcrumb">
      <div class="row">
          <div class="col-lg-12">
                  <h4 class="heading">Trade Deals </h4>
                  <ul class="links">
                      <li>
                          <a href="{{ route('vendor-dashboard') }}">{{ $langg->lang441 }} </a>
                      </li>
                      <li>
                          <a href="{{ route('vendor-postrequest-submitquote') }}">Trade Deal</a>
                      </li>
                  </ul>
          </div>
      </div>
							...
							<div class="mr-table allproduct message-area  mt-4">
								...
								<div class="table-responsiv">
                                    <table class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        @php
                                          $data = DB::table('postrequest_quotes')->where('user_id', Auth::user()->id)->orderBy('id','desc')->where('status', 1)->get();
                                          //dd($data);
                                          $i = 1;
                                          foreach ($data as $value) {
                                            ...
                                            <tr>
                                              ...
                                              <td>".$post_company[0]->product_name."</td>
