                        ...
                        @foreach($convs as $conv)
                          ...
                          <tr class="conv">
                            ...
                            <td>
                              ...
                              <a href="javascript:;" data-toggle="modal" data-target="#confirm-delete" data-href="{{route('vendor-message-delete',$conv->id)}}" class="link remove"><i class="fa fa-trash"></i></a>
                            </td>
