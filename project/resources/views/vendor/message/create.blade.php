        ...
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('vendor-messages') }}">Message</a>
                        </li>
                    </ul>
            </div>
        </div>
                    ...
                    <div class="order-history">
                        <div class="header-area">
                            <h4 class="title">
                                ...
                                @else
                                {{$conv->sent->name}}
                                @endif <a class="mybtn1" href="{{ route('vendor-messages') }}"> <i
                        ...
                        <div class="support-ticket-wrapper ">
                            <div class="panel panel-primary">
                                                ...
                                                <div class="reply-area">
                                                    <div class="left">
                                                        ...
                                                        <img class="img-circle"
                                                            ...
                                                            alt="">
                                                        @endif
                                                        <p class="ticket-date">{{ $message->conversation->sent->name }}
                                                        </p>
                                                    </div>
                                                    <div class="right">
                                                        <p>{{ $message->message }}</p>
                                ...
                                <div class="panel-footer">
                                    <form id="messageform" data-href="{{ route('user-vendor-message-load',$conv->id) }}"
