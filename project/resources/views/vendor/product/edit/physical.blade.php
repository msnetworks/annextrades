                        ...
                        @include('includes.vendor.form-both')
											...
											<div class="#{{ $data->measure == null ? 'showbox' : '' }}">
												...
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading">Product Unit*</h4>
														</div>
													</div>
													<div class="col-lg-7">
														<input type="hidden" name="measure_check" id="allowProductMeasurement" value="1" {{ $data->measure == null ? '' : 'checked' }}>
															<select id="product_measure" name="measure">
																<option value="" {{$data->measure == null ? 'selected':''}}>{{ __('Select Unit') }}</option>
