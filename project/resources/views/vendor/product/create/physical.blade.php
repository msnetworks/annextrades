                                  ...
                                  <option value="">{{ $langg->lang639 }}</option>
														...
														<div class="img-upload">
													  	...
													  	{{-- <div class="row">
															<div class="panel panel-body">
																<div class="span4 cropme text-center" id="landscape" style="width: 400px; height: 400px; border: 1px dashed black;"></div>
															</div>
														</div>
											...
											<div class="#showbox">
												...
												<div class="row">
													...
													<div class="col-lg-7">
															<input type="hidden" name="measure_check" class="/*checkclick*/" id="allowProductMeasurement" value="1">
