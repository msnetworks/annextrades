...
class User extends Authenticatable
{
    ...
    protected $fillable = ['name','photo','state','zip','residency','city','country', 'address', 'phone', 'fax', 'email','password','affilate_code','verification_link','shop_name','owner_name','shop_number','shop_address','reg_number','business_type','no_employees','target_market','annual_volume','export_percentage','monthly_capacity','facility_capacity','shop_message','already_export','which_country','is_vendor','shop_details','shop_image','f_url','g_url','t_url','l_url','f_check','g_check','t_check','l_check','shipping_cost','date','mail_sent','balance'];
