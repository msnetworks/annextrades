...
class PostRequestController extends Controller
{
   ...
   {
       return view('user.postrequirement.index');
   }
   public function quote($id)
   {
       return view('user.postrequirement.quotes')->with('id', $id);
   }
   public function submitquote()
   {
       return view('user.postrequirement.submitquotes');
   }
   public function edit($id)
    {
        $data = DB::table('PostRequest')->where('id', $id)->get();
        return view('user.postrequirement.edit_postrequirement')->with('data', $data);
    }
