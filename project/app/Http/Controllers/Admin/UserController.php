             ...
             return Datatables::of($datas)
                                ->addColumn('action', function(User $data) {
                                    if ($data->email_verified == 'Yes') {
                                        ...
                                        $verify = '<a target="_blank" href="https://annextrades.com/user/register/verify/'.$data->verification_link.'">Verify Email</a>';
                                    }
                                    ...
                                    return '<div class="action-list">
                                        ...
                                        <i class="fas fa-dollar-sign"></i> Manage Deposit</a><a href="' . route('admin-user-show',$data->id) . '" > <i class="fas fa-eye"></i> Details</a>
                                        ...
                                        '.$ban.'<a href="javascript:;" data-href="' . route('admin-user-delete',$data->id) . '" data-toggle="modal" data-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a>
                                        '.$verify.'</div>';
...
// OTHER SECTION ENDS
        ...
        {
           return view('admin.user.add_new');
        }
}