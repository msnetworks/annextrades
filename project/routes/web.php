...
Route::prefix('admin')->group(function() {
  ...
  Route::get('/postrequirement', 'Admin\PostRequestController@postrequirement')->name('admin-post-requirement');
  Route::get('/postrequirement/datatable', 'Admin\PostRequestController@postrequirement_datatables')->name('admin-post-requirement-datatables'); //JSON REQUEST
  Route::get('/postrequirementquote', 'Admin\PostRequestController@quote')->name('admin-post-requirement-quote'); //JSON REQUEST
  Route::get('/postquotes/{id}', 'Admin\PostRequestController@quotes')->name('admin-post-quote'); //JSON REQUEST
  Route::get('/postrequirementquote/datatable', 'Admin\PostRequestController@quotedatatables')->name('quotedatatables'); //JSON REQUEST
  Route::get('/postrequirement/status/{id1}/{id2}', 'Admin\PostRequestController@status')->name('admin-postrequirement-status');
  Route::get('/postrequirement/highlight/{id1}/{id2}', 'Admin\PostRequestController@highlight')->name('admin-postrequirement-highlight');
  Route::get('/postquote/status/{id1}/{id2}', 'Admin\PostRequestController@qutoestatus')->name('admin-postquote-status');
  Route::get('/postquote/add_new', 'Admin\PostRequestController@add_new')->name('admin-addnew');
  Route::POST('/postquote/add_new', 'Admin\PostRequestController@insert')->name('admin-addnew-insert');
  Route::get('/postquote/notification/{id}', 'Admin\PostRequestController@notification')->name('admin-notification');
  Route::get('/postquote/edit/{id}', 'Admin\PostRequestController@edit')->name('admin-postrequest-edit');
  Route::POST('/postquote/update', 'Admin\PostRequestController@update')->name('admin-postrequest-update');
  Route::get('/postquote/download/{id}/{id1}', 'Admin\PostRequestController@downloadfile')->name('admin-postrequest-download');
  Route::get('deal/delete/{id}', 'Admin\PostRequestController@delete')->name('deal-delete');
  //------------ ADMIN PRODUCT SECTION ------------


  Route::get('/government-contracts', 'Admin\GovernmentContract@index')->name('admin-government-contracts');
  Route::get('/government-contract-add', 'Admin\GovernmentContract@add')->name('admin-government-contract-add');
  Route::POST('/government-contract-insert', 'Admin\GovernmentContract@insert')->name('admin-government-contract-insert');
  Route::get('/government-contract-edit/{id}', 'Admin\GovernmentContract@edit')->name('admin-government-contract-edit');
  Route::POST('/government-contract-update', 'Admin\GovernmentContract@update')->name('admin-government-contract-update');
  Route::get('/government-contract-list', 'Admin\GovernmentContract@list')->name('admin-government-contract-list');
  Route::get('/government-contract-change-status/{id1}/{id2}', 'Admin\GovernmentContract@change_status')->name('admin-government-contract-change-status');
  Route::get('/government-contract-change-highlight/{id1}/{id2}', 'Admin\GovernmentContract@change_highlight')->name('admin-government-contract-change-highlight');
  Route::get('government-contract-delete/{id}', 'Admin\GovernmentContract@delete')->name('admin-government-contract-delete');
  Route::get('government-contract-import', 'Admin\GovernmentContract@import')->name('admin-government-contract-import');
  Route::post('government-contract-import', 'Admin\GovernmentContract@import_process')->name('admin-government-contract-import');
  


  Route::get('/admin-bookmark-us', 'Admin\BookmarkUSController@index')->name('admin-bookmark-us');
  Route::get('/admin-bookmark-us-add', 'Admin\BookmarkUSController@add')->name('admin-bookmark-us-add');
  Route::post('/admin-bookmark-us-insert', 'Admin\BookmarkUSController@insert')->name('admin-bookmark-us-add');
  Route::get('/admin-bookmark-us-edit/{id}', 'Admin\BookmarkUSController@edit')->name('admin-bookmark-us-edit');
  Route::post('/admin-bookmark-us-edit/{id}', 'Admin\BookmarkUSController@edit')->name('admin-bookmark-us-edit');
  Route::get('/admin-bookmark-list', 'Admin\BookmarkUSController@list')->name('admin-bookmark-list');
  ...
  Route::get('/products/update', 'Admin\ProductController@updates')->name('admin-product-update');
  ...
  Route::get('/users/register', 'Admin\UserController@add_new')->name('admin-add-user');
...
// Verification Section Ends
  ...
  Route::get('/category-us/datatables', 'Admin\CategoryUSController@datatables')->name('admin-cat-us-datatables'); //JSON REQUEST
  Route::get('/category-us', 'Admin\CategoryUSController@index')->name('admin-cat-us-index');
  Route::get('/category-us/create', 'Admin\CategoryUSController@create')->name('admin-cat-us-create');
  Route::post('/category-us/create', 'Admin\CategoryUSController@store')->name('admin-cat-us-store');
  Route::get('/category-us/edit/{id}', 'Admin\CategoryUSController@edit')->name('admin-cat-us-edit');
  Route::post('/category-us/edit/{id}', 'Admin\CategoryUSController@update')->name('admin-cat-us-update');
  Route::get('/category-us/delete/{id}', 'Admin\CategoryUSController@destroy')->name('admin-cat-us-delete');
  Route::get('/category-us/status/{id1}/{id2}', 'Admin\CategoryUSController@status')->name('admin-cat-us-status');


  Route::get('/bookmark-us/datatables', 'Admin\BookmarkUSController@datatables')->name('admin-book-us-datatables'); //JSON REQUEST
  Route::get('/bookmark-us', 'Admin\BookmarkUSController@index')->name('admin-book-us-index');
  Route::get('/bookmark-us/create', 'Admin\BookmarkUSController@create')->name('admin-book-us-create');
  Route::post('/bookmark-us/create', 'Admin\BookmarkUSController@store')->name('admin-book-us-store');
  Route::get('/bookmark-us/edit/{id}', 'Admin\BookmarkUSController@edit')->name('admin-book-us-edit');
  Route::post('/bookmark-us/edit/{id}', 'Admin\BookmarkUSController@update')->name('admin-book-us-update');
  Route::get('/bookmark-us/delete/{id}', 'Admin\BookmarkUSController@destroy')->name('admin-book-us-delete');
  Route::get('/bookmark-us/status/{id1}/{id2}', 'Admin\BookmarkUSController@status')->name('admin-book-us-status');



  // Route::get('/category-us', 'Admin\CategoryUSController@index')->name('admin-category-us');
  // Route::get('/category-us-create', 'Admin\CategoryUSController@create')->name('admin-category-us-create');
  // Route::post('/category-us-insert', 'Admin\CategoryUSController@insert')->name('admin-category-us-insert');
  // Route::get('/admin-category-us-edit/{id}', 'Admin\CategoryUSController@edit')->name('admin-category-us-edit');
  // Route::post('/admin-category-us-edit/{id}', 'Admin\CategoryUSController@edit')->name('admin-category-us-edit');
  // Route::post('/admin-category-us-delete/{id}', 'Admin\CategoryUSController@delete')->name('admin-category-us-delete');
  // Route::get('/admin-category-list', 'Admin\CategoryUSController@list')->name('admin-category-list');
...
Route::prefix('user')->group(function() {
  ...
  Route::get('/personalised-notifications', 'User\UserController@personalised_notifications')->name('user-personalised-notifications');
  ...
  // Post Requirement
  Route::get('/postrequirement', 'User\PostRequestController@index')->name('user-postrequest');
  Route::get('/postrequirement/quote/{id}', 'User\PostRequestController@quote')->name('user-postrequest-quote');
  Route::get('/postrequirement/submitquote/', 'User\PostRequestController@submitquote')->name('user-postrequest-submitquote');
  Route::get('/postrequirement/edit/{id}', 'User\PostRequestController@edit')->name('user-postrequest-edit');
  Route::post('/postrequirement/update/', 'User\PostRequestController@update')->name('user-postrequest-update');
...
// User Subscription
  ...
  Route::post('/message/buybulk','User\MessageController@buyBulk')->name('buy-bulk');
  ...
  //Requests for bulk
  Route::get('/requests', 'User\UserController@requests')->name('user-requests');
...
Route::prefix('vendor')->group(function() {
  ...
  // Vendor Dashboard
  Route::get('/category-notifications', 'Vendor\VendorController@category_notifications')->name('vendor-category-notifications');
  Route::get('/save-category-notifications', 'Vendor\VendorController@save_category_notification')->name('vendor-save-category-notification');
  Route::get('/delete-category-notifications', 'Vendor\VendorController@delete_category_notification')->name('vendor-delete-category-notification');
  Route::get('/location-notifications', 'Vendor\VendorController@location_notifications')->name('vendor-location-notifications');
  Route::get('/save-location-notifications', 'Vendor\VendorController@save_location_notification')->name('vendor-save-location-notification');
  Route::get('/delete-location-notifications', 'Vendor\VendorController@delete_location_notification')->name('vendor-delete-location-notification');
  Route::get('/notifications', 'Vendor\VendorController@notifications')->name('vendor-notifications');

  // User Reset
   Route::get('/reset', 'Vendor\UserController@resetform')->name('vendor-reset');
   Route::post('/reset', 'Vendor\UserController@reset')->name('vendor-reset-submit');
   // User Reset End

   // Deposit Section
  Route::get('/deposit/transactions', 'Vendor\DepositController@transactions')->name('vendor-transactions-index');
  Route::get('/deposit/transactions/{id}/show', 'Vendor\DepositController@transhow')->name('vendor-trans-show');
  Route::get('/deposit/index', 'Vendor\DepositController@index')->name('vendor-deposit-index');
  Route::get('/deposit/create', 'Vendor\DepositController@create')->name('vendor-deposit-create');
  ...
  Route::post('/user/contact', 'Vendor\MessageController@usercontact');
  ...
  Route::post('/message/post', 'Vendor\MessageController@postmessage')->name('vendor-message-post');
  Route::get('/message/{id}/delete', 'Vendor\MessageController@messagedelete')->name('vendor-message-delete');
  Route::get('/message/load/{id}', 'Vendor\MessageController@msgload')->name('vendor-vendor-message-load');
  Route::post('/message/buybulk','Vendor\MessageController@buyBulk')->name('buy-bulk');
  ...
  Route::get('/orders', 'Vendor\OrderController@orders')->name('vendor-orders');
  //Route::get('/order/tracking', 'Vendor\OrderController@ordertrack')->name('vendor-order-track');
  //Route::get('/order/trackings/{id}', 'Vendor\OrderController@trackload')->name('vendor-order-track-search'); 
  //Route::get('/order/{id}', 'Vendor\OrderController@order')->name('vendor-order');
  //Route::get('/download/order/{slug}/{id}', 'Vendor\OrderController@orderdownload')->name('vendor-order-download');
  //Route::get('print/order/print/{id}', 'Vendor\OrderController@orderprint')->name('vendor-order-print');

  // User Orders Ends

  //Request
  //Requests for bulk
  Route::get('/requests', 'Vendor\ProductQuoteController@requests')->name('vendor-requests');
  Route::get('/requests/view/{id}', 'Vendor\ProductQuoteController@requests_view')->name('vendor-requests-view');
  Route::POST('/productQuote', 'Vendor\ProductController@quoteSubmit')->name('vendor-product-quote');
  Route::get('/productQuote/transactions', 'Vendor\ProductQuoteController@transactions')->name('vendor-product-transactions');
  Route::get('/productQuote/statusupdate/{id}/{id1}', 'Vendor\ProductQuoteController@statusupdate')->name('vendor-product-updatestatus');
  Route::post('/productQuote/makeoffer', 'Vendor\ProductQuoteController@makeoffer')->name('vendor-product-makeoffer');
  Route::post('/productQuote/editoffer', 'Vendor\ProductQuoteController@editoffer')->name('vendor-product-editoffer');
  

  // User Admin Send Message Ends
  // Post Requirement
  Route::get('/postrequirement', 'Vendor\PostRequirement@index')->name('vendor-postrequest');
  Route::get('/postrequirement/quote/{id}', 'Vendor\PostRequirement@quote')->name('vendor-postrequest-quote');
  Route::get('/postrequirement/submitquote/', 'Vendor\PostRequirement@submitquote')->name('vendor-postrequest-submitquote');
  Route::get('/postrequirement/edit/{id}', 'Vendor\PostRequirement@edit')->name('vendor-postrequest-edit');
  Route::post('/postrequirement/update/', 'Vendor\PostRequirement@update')->name('vendor-postrequest-update');
  // End Post Requirement
...
// ************************************ FRONT SECTION **********************************************
  ...
  Route::post('/', 'Front\FrontendController@insert')->name('post-request-insert');
  ...
  Route::get('/about-us', 'Front\FrontendController@about_us')->name('front.about-us');
  ...
  // TAG SECTION ENDS
  // TAG SECTION
  Route::get('/pricing/','Front\PricingController@index')->name('front.pricing');
  Route::get('/pricing/free','Front\PricingController@free')->name('front.free');
  // TAG SECTION ENDS

  // TAG SECTION
  Route::get('/pricing-us/','Front\PricingUSController@index')->name('front.pricing-us');
  Route::get('/pricing/free','Front\PricingUSController@free')->name('front.free');
  // TAG SECTION ENDS

  //DEALS BULLETAIN
  Route::get('/postrequirement', 'Front\PostRequestController@home')->name('front-postrequirement');
  Route::get('/dealsbulletin', 'Front\PostRequestController@index')->name('deals-bulletain');
  Route::get('/dealsbulletin/datatable', 'Front\PostRequestController@Datatable')->name('postrequest-datatables');
  Route::get('/dealsbulletin/favourite', 'Front\PostRequestController@favourite')->name('deal-fav');
  Route::get('/dealsbulletin/removefavourite', 'Front\PostRequestController@favouriteRemove')->name('deal-fav-remove');
  Route::get('/dealsbulletin/countfavourite', 'Front\PostRequestController@favouriteCount')->name('deal-fav-count');
  Route::get('/viewquote/{id}', 'Front\PostRequestController@viewquote')->name('viewquote');
  Route::get('/submitquote/{id}', 'Front\PostRequestController@submitquote')->name('submitquote')->middleware('auth');
  Route::POST('/submitquote', 'Front\PostRequestController@quoteSubmit')->name('quote-submit');
  Route::get('/downloadfile/{id}/{id1}', 'Front\PostRequestController@downloadfile')->name('front-postrequest-download');
  //DEALS BULLETAIN END

  //GOVERNMENT CONTRACT
  Route::get('/government-contract', 'Front\GovernmentContractController@index')->name('government-contract');
  Route::get('/government-contract-details/{id}', 'Front\GovernmentContractController@details')->name('government-contract-details');
  Route::get('/government-contract-list', 'Front\GovernmentContractController@list')->name('government-contract-list');
  Route::get('/government-contract-count-favourite', 'Front\GovernmentContractController@count_favourite')->name('government-contract-count-favourite');
  Route::get('/government-contract-add-favourite', 'Front\GovernmentContractController@add_favourite')->name('government-contract-add-favourite');
  Route::get('/government-contract-remove-favourite', 'Front\GovernmentContractController@remove_favourite')->name('government-contract-remove-favourite');
  
  //GOVERNMENT CONTRACT END
  ...
  Route::get('/vendor/shoot_email','Front\FrontendController@shoot_email');
  // CRONJOB ENDS
