...
if (isset($_POST['submit'])) {
    ...
    // if everything is ok, try to upload file
      ...
      if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
        ...
        $img = $target_file1;
    $edit = "UPDATE feature_post SET title='$title', active='$active', image = '$img', category_id='$category_id', sort_summary='$sort_summary' , content='$content' WHERE id='$id'";
    ...
    if($sql){
        ...
        echo '<meta http-equiv="refresh" content="0;url=../feature_posts.php?msg=Success">';
            ...
            echo 'failed';
            echo '<meta http-equiv="refresh" content="0;url=../feature_posts.php?msg=Failed">';
        }
}
?>