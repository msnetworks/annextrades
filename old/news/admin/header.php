...
<head>
  <meta charset="utf-8" />
    <title>Annexis Business Solution - Admin Panel</title>
...
<nav class="navbar navbar-default navbar-static-top">
	...
	<div class="navbar-header">
	  ...
	  <a class="navbar-brand" href="dashboard.php"><img title="Annexis Trade"  src="../asset/img/nlogo.png" width="180px" height="" alt=""></a>
	  </div>
...
?>><a href="add_post.php"><i class="fa fa-edit"></i> Add Feature Guest Post</a></li>
<li <?php
if (basename($_SERVER['SCRIPT_NAME']) == 'feature_posts.php') {
    echo 'class="active"';
}
?>><a href="feature_posts.php"><i class="fa fa-list-ul"></i> Feature Posts</a></li>
         <li <?php
if (basename($_SERVER['SCRIPT_NAME']) == 'add_news_post.php') {
    echo 'class="active"';
}
?>><a href="add_news_post.php"><i class="fa fa-edit"></i> Add News Post</a></li>
		  <li <?php
if (basename($_SERVER['SCRIPT_NAME']) == 'posts.php') {
    echo 'class="active"';
}
?>><a href="news_posts.php"><i class="fa fa-list-ul"></i> News Posts</a></li>
		  <li <?php
if (basename($_SERVER['SCRIPT_NAME']) == 'categories.php') {
    echo 'class="active"';
}
?>><a href="categories.php"><i class="fa fa-list-alt"></i> Categories</a></li>
          <li <?php
if (basename($_SERVER['SCRIPT_NAME']) == 'comments.php') {
    echo 'class="active"';
}
?>><a href="comments.php"><i class="fa fa-comments-o"></i> Comments</a></li>
<!-- <li class="nav-header">Add Products</li>
          <li <?php
if (basename($_SERVER['SCRIPT_NAME']) == 'add_bulk_product.php') {
    echo 'class="active"';
}
?>><a href="add_bulk_product.php"><i class="fa fa-edit"></i> Add Bulk Product</a></li> -->
		  <li class="nav-header">Services</li>
          <li <?php
if (basename($_SERVER['SCRIPT_NAME']) == 'add_service_category.php') {
    echo 'class="active"';
}
?>><a href="add_service_category.php"><i class="fa fa-edit"></i> Add Service Category</a></li>
            <li <?php
if (basename($_SERVER['SCRIPT_NAME']) == 'add_service_subcategory.php') {
    echo 'class="active"';
}
?>><a href="add_service_subcategory.php"><i class="fa fa-edit"></i> Add Service Sub-Category</a></li>
    <li class="nav-header">Email Details</li>
          <li <?php
if (basename($_SERVER['SCRIPT_NAME']) == 'composemail.php') {
    echo 'class="active"';
}
?>><a href="composemail.php"><i class="fa fa-envelope"></i> Compose New Mail</a></li>
           <li <?php
if (basename($_SERVER['SCRIPT_NAME']) == 'sendmail.php') {
    echo 'class="active"';
}
?>><a href="sendmail.php"><i class="fa fa-inbox"></i> Send Mail</a></li>
<li <?php
if (basename($_SERVER['SCRIPT_NAME']) == 'add_clientemail.php') {
    echo 'class="active"';
}
?>><a href="add_clientemail.php"><i class="fa fa-plus"></i> Add New E-Mail</a></li> 
