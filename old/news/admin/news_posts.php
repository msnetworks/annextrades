	...
	<div class="col-md-9">
	  ...
	  <div class="row">
        <div class="col-md-12 column">
            <div class="box">
              <h4 class="box-header round-top">News Posts</h4>         
              <div class="box-container-toggle">
                  <div class="box-content">
				  <center><a href="add_news_post.php" class="btn btn-default"><i class="fa fa-edit"></i> Add Post</a></center><br />
                    <?php
                                ...
                                ';
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo '
                                                <tr>
                                                    <td>' . $row['id'] . '</td>
                                                    <td><center><img src="../asset/img/news/'.$row['image'].'" width="45px" height="45px" /></center></td>
                                                    <td>' . $row['title'] . '</td>
                                                    <td>' . $row['date'] . '</td>';
                                        if ($row['active'] == "Yes") {
                                            echo '<td>Yes</td>';
    ...
    <div class="row">
        <div class="col-md-12 column">
            <div class="box">
              ...
              <div class="box-container-toggle">
                  <div class="box-content">
                        <center><form action="controller/edit_news_post.php" enctype="multipart/form-data" method="post">
								<p>
									<label>Title</label>
								...
								<p>
									...
									<img src="../asset/img/news/<?php echo $row['image']; ?>" width="50px" height="50px" /><br />
