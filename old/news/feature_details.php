<?php 
    ...
    $runq = mysqli_query($connect, "SELECT * FROM `feature_post` WHERE id='$id'");
            ...
            <div class="container">
                ...
                <div class="col-lg-8" style="font-size: 15px !important;">
                    ...
                    <div class="title-divider pd-tp-30">
                        <h1 class="line-sp" style="font-size: 30px; padding-left: 0px!important;"><?php echo $row['title'];?></h1><br>
                    </div>
                    <font class="lead" style="font-size: 12px;">Posted on <?php echo $row['date']; ?></font>
                    <!-- Author - ->
                    <p class="lead">
                    by
                    ...
                    <!-- Preview Image -->
                    <img class="img-fluid rounded w-100 shdw zmin" style="/* height: 300px; */ border-radius: 0px!important;" src="asset/img/feature/<?php echo $row['image'];?>" alt="">
                    ...
                    <div class="card my-4">
                        ...
                        <div class="wrap-300">
                            < ?php
                                $q = mysqli_query($connect, "SELECT * FROM `feature_comments` WHERE post_id='$row[id]' AND approved='Yes' ORDER BY id DESC");
                        ...
                        <div class="card-body">
                            <form action="controllers/feature_comments.php?id=< ?php echo $id; ?>" method="post">
                ...
                <div class="col-md-4 pd-0 mr-0" style="background: #fbfbfb;">                    
                            ...
                            <ul class="pd-lft-0">
                                <?php
                                    ...
                                    while ($c = mysqli_fetch_array($cunq)) {
                                        $cunq1 = mysqli_query($connect, "SELECT * FROM `feature_post` WHERE category_id='$c[id]'");
                                        $cNum = mysqli_num_rows($cunq1);
                                ?>
                                    <li class="list-group-item border-0 pd-lft-0" ><span class="badge">(<?php echo $cNum; ?>)</span><a style="color: #787878!important; font-weight: bold;" href="feature_category_list.php?category_id=<?php echo $c['id'];?>"><!--i class="fa fa-arrow-right" "=""></i-->&nbsp; <?php echo $c['category'];?></a></li>
                                <hr>
                                <?php
                                    }
                                ?>
                    ...
                    <section class="mr-tp-30 bdr-0" id="tabs">
                        ...
                        <div class="tab-content bdr-0">
                            ...
                            <?php
                                $run   = mysqli_query($connect, "SELECT * FROM `feature_post` WHERE active='Yes' ORDER BY views DESC LIMIT 4");
                                    ...
                                    while ($row = mysqli_fetch_assoc($run)) {
                                        ...
                                        <div class="media">
                                            <div class="media-left">
                                                <a href="feature_details.php?id=' . $row['id'] . '"><img class="media-object" style="width: 80px; height:90px; border-radius: 0px;" src="asset/img/feature/' . $row['image'] . '" style="width: 64px; height: 64px;"></a>
                                            </div>
                                            <div class="media-body pd-lft-15">
                                                <a href="feature_details.php?id=' . $row['id'] . '"><h4 class="media-heading">' . $row['title'] . '</h4></a>
                            ...
                            <?php
                                $run   = mysqli_query($connect, "SELECT * FROM `feature_post` WHERE active='Yes' ORDER BY id DESC LIMIT 4");
                                $count = mysqli_num_rows($run);
                                if ($count <= 0) {
                                    echo '<br><center>There are no published posts</center><br>';
                                } else {
                                    while ($row = mysqli_fetch_assoc($run)) {
                                        $post_id = $row['id'];
                                        $runq3   = mysqli_query($connect, "SELECT * FROM `feature_comments` WHERE post_id='$post_id' AND approved='Yes'");
                                        $uNum    = mysqli_num_rows($runq3);
                                        echo '
                                        <div class="media">
                                            <div class="media-left">
                                                <a href="feature_details.php?id=' . $row['id'] . '"><img class="media-object" src="asset/img/feature/'. $row['image'] .'" style="width: 64px; height: 64px;"></a>
                                            </div>
                                            <div class="media-body pd-lft-15">
                                                <a href="feature_details.php?id=' . $row['id'] . '"><h4 class="media-heading">' . $row['title'] . '</h4></a>
                                                <i class="fa fa-clock-o"></i> ' . $row['date'] . ' at ' . $row['time'] . '<br />
