...
<div class="products-cate-heading"> <span><strong><?php echo "Sold Products"; ?></strong></span> <!--<span style="float:right;"><a href="addsell_leads.php" style="font-weight:bold;"><?php echo $add_sel_lead; ?></span> --></div>
...
{
$select = "SELECT * FROM `tbl_seller` WHERE $query and status='2' and user_id='$session_user' and payad_status='1' and lang_status='0' order by seller_id desc";
}
else if($_SESSION['language']=='french')
{
$select = "SELECT * FROM `tbl_seller` WHERE $query and status='2' and user_id='$session_user' and payad_status='1' and lang_status='1' order by seller_id desc";
}
else if($_SESSION['language']=='chinese')
{
$select = "SELECT * FROM `tbl_seller` WHERE $query and status='2' and user_id='$session_user' and payad_status='1' and lang_status='2' order by seller_id desc";
}
else
{
$select = "SELECT * FROM `tbl_seller` WHERE $query and status='2' and user_id='$session_user' and payad_status='1' and lang_status='3' order by seller_id desc";
}
}
else
{
...
$select = "SELECT * FROM `tbl_seller` where status='2' and user_id='$session_user' AND trash!='1' and payad_status='1' AND lang_status='0' order by seller_id desc";
}
else if($_SESSION['language']=='french')
{
$select = "SELECT * FROM `tbl_seller` where status='2' and user_id='$session_user' AND trash!='1' and payad_status='1' AND lang_status='1' order by seller_id desc";
}
else if($_SESSION['language']=='chinese')
{
$select = "SELECT * FROM `tbl_seller` where status='2' and user_id='$session_user' AND trash!='1' and payad_status='1' AND lang_status='2' order by seller_id desc";
}
else
{
$select = "SELECT * FROM `tbl_seller` where status='2' and user_id='$session_user' AND trash!='1' and payad_status='1' AND lang_status='3' order by seller_id desc";
}
 }
...
<td width="250">
 ...
 <a  class="news" href="companyinfo.php?id=<?php echo $fetch_product['seller_id'];?>"><?php echo $fetch_product['seller_subject']; ?></a></td><td width="50"><img src="<?php echo "flags/".$result['country_flag'];?>" /><br /><?php echo $result['country_name']; ?></td><td width="50" class="enquire" ><a href=
							<?php 
							if(isset($sess_id))
							{
							if($uid==$sess_id)
							...
							{
							?>
							 "send_action.php?id=<?php echo $fetch_product['seller_id'];?>"
							 <?php
							 }
							 }else{ 
							?>"login.php" 
							...
							?> class="topics2"><img src="images/mail2.jpg" border="0"/> <?php echo $inquiry; ?><br /></a>
                            <?php /*?>&nbsp;&nbsp;<a href="billing.php?pro_id=<?php echo $fetch_product['seller_id'];?>" class="classname" style="color:#FFF;"><?php echo $buy_now; ?></a> <?php */?>
