    ...
    <div class="body-cont1">
        <div class="row">
            ...
            <?php
                ...
                <center><span style="padding-left:300px; color:#009900; font-weight:bold; padding-top: 30px;"> <!-- Confirmation Mail Sent To Your Email --> Company Information Updated Successfully.</span></center>
            <?php } ?>
            </div>
        </div>
            ...
            <div class="body-right">
                ...
                <div class="tabs-cont">
                    <div class="left" style="border:1px solid #F0EFF0; border-radius:5px;">
                        <div class="bordersty" style="padding: 15px;">
                            <div class="headinggg"> Company Details </div>
                                <div class="input-group" style="padding: 15px;">
                                    <label><span style="color:#FF0000">*</span><span><b><?php echo $required_info; ?></b></span>
                                    </label>
                                </div>
                                <form action="controller/edit_company.php?id=<?php echo $userId; ?>"  enctype="multipart/form-data" name="profile_form" method="post" onSubmit="return validate1_form();">
                                    <div class="input-group" >
                                        <!-- <h6>Company Logo</h6><br> -->
                                        <input type="text" name="logo" value="<?php echo $companyInfo['companylogo']; ?>" hidden/>
                                        <!-- <div class="dropzone dropzone-previews" id="my-awesome-dropzone"></div> -->
                                        <input type='file' id="companylogo" name="companylogo" class="inputfile" onchange="readURL(this);" />
                                        <label for="companylogo" style="height: 151px; width: 151px; border: 1px solid #333;">
                                        <img id="blah" src="company_images/<?php echo $companyInfo['companylogo']; ?>" style="height: 149px; width: 149px;" title="Add Company Logo" /></label>
                                        <script>
                                        ...
                                        <!-- <div style="width: fit-content; height: 200px;" class="dropBoxContainer">
                                            <form action="upload.php" style="padding: 0px;" class="dropzone" id="dropzoneFrom" enctype="multipart/form-data">
                                            </form>
                                        </div>
                                        <div align="center">
                                        ...
                                        <!-- <div class="container" id=""><img src="productlogo/< ?php echo $companyInfo['photo']; ?>" alt=""></div> -->
                                    </div>
                                    ...
                                    <div class="input-group">
                                        <h6><?php echo $country1; ?> : <?php echo $row_country['country_name']; ?></h6>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <h6><span style="color:#FF0000">*</span><?php echo $bussiness_mail; ?></h6>
                                            <input name="companymail" value="<?php echo  $companyInfo['mailid']; ?>" placeholder="Email" type="text" class="txtfield2_new" id="companymail" />
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="bussiness_type" class="txtfield2_new" id="bussiness_type">
                                            ...
                                            <option value="$companyInfo['bussiness_type']"></option>
                                            <option value="Manufacturer" <?php if ($companyInfo['bussiness_type'] == 'Manufacturer') { ?> selected="selected" <?php } ?>>Manufacturer</option>
                                            <option value="Merchant" <?php if ($companyInfo['bussiness_type'] == 'Merchant') { ?> selected="selected" <?php } ?>>Merchant</option>
                                            <option value="Wholesale Trader" <?php if ($companyInfo['bussiness_type'] == 'Wholesale Trader') { ?> selected="selected" <?php } ?>>Wholesale Trader</option>
                                            ...
                                            <option value="Distrubutor" <?php if ($companyInfo['bussiness_type'] == 'Distrubutor') { ?> selected="selected" <?php } ?>>Distributor</option>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="info">eg.. Computer,Iron<?php echo $eg_product; ?></div>
                                    </div>
                                    <div class="input-group">
                                    ...
                                    <!-- <div class="input-group">
                                        <h6><span style="color:#FF0000">*</span>< ?php echo $com_logo; ?></h6>
                                        <input type="file" name="companylogo" id="companylogo" class="txtfield2_new" />
                                        <input type="text" name="logo1" value="< ?php echo $companyInfo['companylogo']; ?>" hidden>
                                        <div class="info">eg.. jpg,jpeg,gif< ?php echo $eg_logo; ?></div>
                                    </div> -->
                                    <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <h6><?php echo $company_intro; ?></h6>

                                        <textarea name="company_details" type="text" class="txtfield2_new w-100" id="company_details"><?php echo $companyInfo['company_details'];?></textarea>
                                        <script>
                                            CKEDITOR.replace('company_details');
                                        </script>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <h6>REGISTERED CAPITAL<?php /* echo $registerd_capital; */ ?></h6>
                                    ...
                                    <div class="input-group">
                                        <h6>OWNERSHIP TYPE <?php /* echo $ownership_type; */ ?></h6>

                                        <select name="ownertype" class="txtfield2_new" id="ownertype">
                                            <option value="">Select Type </option>
                                            <option value="Corporation/Limited Company" <?php if ($companyInfo['ownertype'] == 'Corporation/Limited Company') { ?> selected="selected" <?php } ?>>Corporation/Limited Company</option>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div>
                                            ...
                                            North America<?php /*echo  $north_america; */ ?></label>
                                            <label>
                                                <input name="market[]" type="checkbox" value="South America" <?PHP if (in_array("South America", $mainmark)) { ?>checked="checked" <?PHP } ?> />
                                                South America<?php /* echo $south_america; */ ?>
                                            </label>
                                            <label>
                                                <input name="market[]" type="checkbox" value="Eastern Europe" <?PHP if (in_array("Eastern Europe", $mainmark)) { ?>checked="checked" <?PHP } ?> />
                                                Eastern Europe<?php /* echo $eastern_eroupe */ ?>
                                            </label>

                                            <label><input name="market[]" type="checkbox" value="Southeast Asia" <?PHP if (in_array("Southeast Asia", $mainmark)) { ?>checked="checked" <?PHP } ?> />
                                            Southeast Asia<?php /*echo  $southeast_asia; */ ?></label>
                                            <label><input name="market[]" type="checkbox" value="Africa" <?PHP if (in_array("Africa", $mainmark)) { ?>checked="checked" <?PHP } ?> />
                                            Africa<?php /* echo $africa; */ ?></label>

                                            <label><input name="market[]" type="checkbox" value="Oceania" <?PHP if (in_array("Oceania", $mainmark)) { ?>checked="checked" <?PHP } ?> />
                                            Oceania</label>

                                            <label><input name="market[]" type="checkbox" value="Mid East" <?PHP if (in_array("Mid East", $mainmark)) { ?>checked="checked" <?PHP } ?> /> 
                                            Mid East<?php /* echo $mid_east; */ ?></label>
                                            <label><input name="market[]" type="checkbox" value="Eastern Asia" <?PHP if (in_array("Eastern Asia", $mainmark)) { ?>checked="checked" <?PHP } ?> />
                                            Eastern Asia<?php /* echo $eastern_asia; */ ?></label>
                                            <label><input name="market[]" type="checkbox" value="Western Europe" <?PHP if (in_array("Western Europe", $mainmark)) { ?>checked="checked" <?PHP } ?> />
                                            Westaern Europe<?php /*  echo $western_europe; */ ?></label>
                                        </div>
                                    </div>

                                    <div class="input-group">
                                        <h6>MAIN CUSTOMER(S)<?php /* echo $main_customer; */ ?></h6>
                                        <input name="maincustomer" value="<?php echo $companyInfo['maincustomer'];  ?>" type="text" class="txtfield2_new" id="maincustomer" />
                                    </div>
                                    <div class="input-group">

                                        <h6>TOTAL ANNUAL SALES VOLUME<?php /*  echo $tot_annual; */ ?></h6>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <h6>TOTAL ANNUAL PURCHASE VOLUME</h6>
                                    ...
                                    <div class="input-group">
                                        <h5>Factory Information<?php /* echo $factory_info; */ ?></h5>
                                    </div>
                                    <div class="input-group">
                                        <h6>FACTORY SIZE<?php /* echo $factory_size; */ ?></h6>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <h6>NO. OF PRODUCTION LINES<?php /* echo $no_production_lines;  */?></h6>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <h6>NO. OF R&D STAFF<?php /* echo $no_rd_staff; */ ?></h6>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <h6>NO. OF QC STAFF<?php /* echo $no_of_qc_staff; */ ?></h6>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <h6>MANAGEMENT CERTIFICATION<?php /* echo $managemrnt_certification; */ ?></h6>
                                    ...
                                    <div class="input-group">
                                        ...
                                        ?>
                                        <h6>CONTRACT MANUFACTURING<?php /* echo $contract_manufacturing; */ ?></h6>
                                        <div>
                                            <label><input name="contactmfcr[]" type="checkbox" id="contactmfcr[]" value="OEM Service Offered" <?PHP if (in_array('OEM Service Offered', $manufacture)) { ?>checked="checked" <?PHP } ?> />
                                                OEM Service Offered<?php /* echo $oem_services; */ ?></label>
                                            <label><input name="contactmfcr[]" type="checkbox" id="contactmfcr[]" value="Buyer Label Offered" <?PHP if (in_array('Buyer Label Offered', $manufacture)) { ?>checked="checked" <?PHP } ?> />
                                                Buyer Label Offered<?php echo $buyer_label_offered; ?></label>
                                            <label><input name="contactmfcr[]" type="checkbox" id="contactmfcr[]" value="Design Service Offered" <?PHP if (in_array('Design Service Offered', $manufacture)) { ?>checked="checked" <?PHP } ?> />
                                                Design Service Offered<?php echo $design_service_offered; ?></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-group">
                                            <input name="Editsubmit" class="search_bg" type="submit" id="Addsubmit123" value="SUBMIT" /><?php /* echo $submit; */ ?>
...
<script>
    ...
    function list_image() {
        $.ajax({
            url: "upload.php?company_id=<?= $companyInfo['id'] ?>",
