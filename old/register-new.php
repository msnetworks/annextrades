...
<html>
    ...
    <div class="container-fluid">
        <div class="row no-gutter">
            <div class="d-none d-md-flex col-md-4 col-lg-4 bg-image" style="height: 100vh;">
            ...
            ?>
                <div class="col-md-8" style="height: 100vh; overflow: scroll;">
                    <div class="container">
                                ...
                                <div class="row col-12 col-sm-12 col-md-12 col-lg-10 col-xl-12 text-center p-0 mt-3 mb-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-right">
                                            ...
                                            <a style="color: #fff;" href="login.php"><button class="action-button" style="padding: 5 10; background: #ff7900; border:0; color:#fff;">Sign In</button></a>
                                                ...
                                                <div class="form-card">
                                                    ...
                                                    <form id="user-form" name="myForm">
                                                        <div class="row ">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-label-group">
                                                                    <!-- <span style="position: absolute; padding-left: 15px; z-index: 1;" id="usercheck"></span> -->
                                                                    <input type="email" name="email" id="email" value="<?php echo $r['email']; ?>"  placeholder="Email Id *" <?php if($r['email'] != ''){echo 'readonly';}?>/>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <input type="password" id="pass" placeholder="Enter passward" name="pass" <?php if($r['password'] != ''){ echo  'value="********"readonly';}?>>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <span class="registrationFormAlert" style="color:green; position: absolute; padding-left: 15px;" id="CheckPasswordMatch"></span>
                                                                <input type="password" id="cpass" placeholder="Confirm Passward" name="cpass" <?php if($r['password'] != ''){ echo  'value="********"readonly';}?>>
                                                            </div>
                                                            <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-12 input-group">
                                                                <label style="padding-right: 20px;  margin-bottom: 0; font-size: 16px;">
                                                                    <input type="checkbox" name="terms" class="w-auto" id="terms" <?php if($r['vendor_id'] != ''){echo 'readonly checked';}?>/> I agree to all AnnexTrades's <a href="terms_of_use.php" target="_blank">Terms & Condition</a> and
                                                    ...
                                                    <?php }else{ ?>
                                                        <script>
                                                            ...
                                                            document.getElementById("save-form2").click();
                                                            };
                                                        </script>
                                                        <input type="button" name="submit"  id="save-form2" class="next action-button" value="Next" />
                                                    <?php } ?>
                                                </form>
                                            </fieldset>
                                            <fieldset id="2" >
                                                        ...
                                                        if (@$email_status == "Verified") { ?>
                                                            <h3 class="text-center" style="color: #28a745!important;"><strong>Email Verification Successfully Completed!</strong></h3> <br>
                                                                <div class="row justify-content-center">
                                                                    <div class=""> <img src="assets/images/loading2.gif" class="w-100"> </div>
                                                                </div> <br><br>
                                                                <div class="row justify-content-center">
                                                            ...
                                                            <input type="button" name="nexsubmitt"  class="next action-button" value="Next" />
                                                            <input type="button" name="previous" id="back2" class="previous action-button-previous" value="Previous" />
                                                            <?php    }else{
                                                            ?>
                                                            <h6 class="text-center" style="font-size: 22px; color:#616161;">Verification mail has been sent on your registered email, please check your Inbox or Spam folder to Verify your account.</h6>
                                                            
                                                            <div class="row justify-content-center">
                                                                <div class=""> <img src="assets/images/loading3.gif" class="w-100"> </div>
                                                            </div> <br><br>
                                                            <div class="row justify-content-center">
                                                                <div class="col-7 text-center">
                                                                    <h2 class="purple-text text-center"><strong>Email Verification Is Pending!</strong></h2> <br>
                                                                </div>
                                                            </div>
                                                        </div> 
                                                        <input type="button" name="nexsubmitt" style="opacity: 5;"  class="action-button" value="Next" disabled/>
                                                        <input type="button" name="previous" id="back2" class="previous action-button-previous" value="Previous" />
                                                    <?php } ?>
                                                <!-- <input type="button" name="previous" id="back2" class="previous action-button-previous" value="Previous" /> -->
                                            </fieldset>
                                            <!-- <fieldset>
                                                        ...
                                                        <div class="col-12" style="align-items: center;">
                                                            <center>
                                                                <div style="height: 100; width: 60%; margin-bottom:25px;">
                                                                    <label for="authorize">
                                                                        <img src="assets/images/imageaut.jpg" style="width:60%" id="authorize" alt="Authorize.net Payment">
                                                                        <input type="radio" id="authorize" style="height: 25px;" value="authorize" name="payment" required>
                                                                    </label>
                                                                </div>
                                                            </center>
                                                        </div>
                                                        <!- - <div class="col-6" style="/* border: 1px solid #333;  */ align-items: center;">
                                                            <center>
                                                                <div style="height: 100; width: 60%;">
                                                                    <label for="paypal">
                                                                        <img src="assets/images/pypal.png" style="width:100%" id="paypal" alt="Paypal Payment">
                                                                        <input type="radio" id="paypal" value="paypal" name="payment" required>
                                                                    </label>
                                                                </div>
                                                            </center>
                                                        </div> - ->
                                                    </div>
                                                    < ?php if ($row['memberid'] == 'Free') { ?>
                                                ...
                                                <script>
                                                        jQuery(document).ready(function($) {
                                                            var form = $('form[name="myform1"]'),
                                                                radio = $('input[name="payment"]'),
                                                                payment = '';
                                                            ...
                                                            radio.change(function(e) {
                                                                ...
                                                                if (payment == 'authorize') {
                                                                    form.attr('action', 'authorize-terminal/index.php');
                                                                } else {
                                                                    form.attr('action', 'paypal-terminal/index.php');
                                                                }
                                                            });
                                                        });
                                                </script>
                                                ...
                                                <div class="form-card">
                                                    ...
                                                    <div class="row justify-content-center">
                                                        <div class="col-7 text-center">
                                                            ...
                                                            <h5 class="purple-text text-center"><a style="color: #ff7900;" href="./login.php">Click Here For Login</a></h5>
                                                        </div>
                                                    </div>
                                                </div>
                                            </fieldset>
...
<script>
    $(document).ready(function(e){
        ...
        $("#user-form").on('submit', function(e){
            ...
            if (x == "") {
                alert("First Name must be filled outbbbb");
                return false;
            }
            ...
            $.ajax({
                ...
                processData:false,
                /* beforeSend: function(){
                    $('#save-form').attr("enabled","enabled");
