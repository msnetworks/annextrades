...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/company_images/',
            'upload_url' => BASEURL.'/company_images/',
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        $file->name = date('Ymdhis').rand().".".$ext;       
    ...
    protected function handle_form_data($file, $index) {
        ...
        $file->companyId = $_POST['companyId'];
    }
