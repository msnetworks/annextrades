...
//session_start();
	...
	$strget="";
	$rowsPerPage = '10';
	$sql="select * from buyingleads where status='3' and id='$uid' order by buy_id desc ";
			...
			<table width="98%" align="left" cellspacing="0" >
				...
				<tr><td height="358" valign="top">
					<table width="732" height="172" align="center" cellspacing="0">
						...
						<?php while($leads=mysqli_fetch_array($result)){
							$image="../".$leads['photo'];
							$memberid=$leads['id'];
						...
						<td colspan="5">
							<table width="734" bgcolor="#FFFFFF">
							  ...
							  <td width="172" valign="top"><?php echo $leads['subject'];?></td>
							  <td width="160" valign="top"><?php echo $name['firstname']." ".$name['lastname'];?></td>
							  <td width="160" valign="top"><?php echo $leads['update_date'];?></td>
							  <td width="78" valign="top"><a href="buyleadshowuser.php?bid=<?php echo $leads['buy_id'];?>&uid=<?php echo $uid;?>"><img src="images/view4.png" style="width:20px; height:20px;" /></a></td>
							  <?php /*?><td width="78" valign="top"><a href="buyleadshowuser.php?bid=<?php echo $leads['buy_id'];?>&uid=<?php echo $uid;?>">Show</a></td><?php */?>
						 	</tr></table>
						 </td>
						</tr>
						<tr><td></td></tr>
