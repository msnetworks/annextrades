...
//session_start();
	...
	if(isset($_REQUEST['delid']))
	{
	  ...
	  mysqli_query($con,"DELETE FROM que_ans WHERE id = '$delid'");
	   mysqli_query($con,"DELETE FROM que_ans_french WHERE id = '$delid'");
	   // mysqli_query($con,"DELETE FROM que_ans_chinese WHERE id = '$delid'");
		mysqli_query($con,"DELETE FROM que_ans_spanish WHERE id = '$delid'");
	  header("Location:help_questions.php?deleted");
	}
?>
...
return false;
	...
	<section id="main" class="column">
		...
		<header><h3 class="tabs_involved">Help Questions</h3><h2 style="padding-top:7px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:history.back(-1);" style="color:#009900;">Back</a></h2>
		</header>
		<div class="tab_container">
			...
			<table width="98%" align="left" cellspacing="0" >
				...
				<tr><td valign="top">
					...
					<table width="550" height="70" align="center" style="border:1px solid #E6E6E6;">
						<?php /*?><?php if(isset($_REQUEST['add'])=="suc"){ ?>
						<tr>
					  ...
					  <?php } ?><?php */?>
						...
						<tr bgcolor="#E6E6E6">
						  <td colspan="4" height="20"><div align="center"><strong>Help Questions</strong></div></td>
					  </tr>
						<tr>
						  <td width="22" class="gboldli">&nbsp;</td>
						  <td width="272">&nbsp;</td>
						  <td width="38">&nbsp;</td>
						  <td width="67"><a href="addnew_questions.php"><b>Add New</b></a></td>
					  </tr>
					  ...
					  <?php $sql=mysqli_query($con,"SELECT * FROM que_ans");
					  ...
					  ?>
						...
						<tr><td class="gboldli">&nbsp;</td>
						  ...
						  <td align="center"><a href="addnew_questions_edit.php?editid=<?php echo $row['id']; ?>"><img src="images/images (1).jpg" style="width:17px; height:17px;"/></a>
						  <a href="help_questions.php?delid=<?php echo $row['id']; ?>" onclick=" return confirm('Are you sure want to delete this record?');"><img src="../images1/delete.jpg" border="0" alt="Delete" /></a></td>
						</tr>
						
						<?php } }else{ ?>
						
						<tr><td class="gboldli">&nbsp;</td>
						  <td align="center" colspan="3">No Questions Available</td>
