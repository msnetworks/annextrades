			...
			<table width="732" height="157" align="center" cellspacing="0">
						...
						<td colspan="5">
							...
							<table width="457" align="center">
								...
								<td>:</td>
								<td style="font-family:'Times New Roman', Times, serif; font-size:13px;"><?php echo $details['p_bdes'];?></td>
								</tr>
								<tr valign="top">
								  <td height="25" style="font-family:'Times New Roman', Times, serif; font-size:13px;">Detailed Description</td>
								  <td>:</td>
								<td style="font-family:'Times New Roman', Times, serif; font-size:13px;"><?php echo $details['p_ddes'];?></td>
								</tr>
