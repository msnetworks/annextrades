...
<link href="css/core-inetdir1.css" rel="stylesheet" type="text/css" />
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="dashboard.php">Website Admin</a> <div class="breadcrumb_divider"></div> <a class="current">Movie Management</a></article>
		</div>
	...
	<section id="main" class="column">
		...
		<header><h3 class="tabs_involved">Site Statistics</h3>
		</header>
		<div class="tab_container">
			<div id="tab1" class="tab_content">
			<form  method="post" name="movies" enctype="multipart/form-data">
					...
					<form name="settings" action="" method="post" onsubmit="return validatesettings();">
				 	  <table width="648">
					  		<tr>
								<td width="640">
									<table width="627" align="center">
										<tr><td height="33" colspan="6" class="normalbold"><b>Recent Statistics</b></td>
										</tr>
										<tr class="seller"><td width="98" height="31"><b>Posted/Type</b></td>
										...
										<tr><td class="seller style2">Today</td>
										...
										<tr><td class="seller style2">Yesterday</td>
										...
										<tr><td class="seller style2">Last 7 Days</td>
										...
										<tr><td class="seller style2">Last 30 Days</td>
							...
							<tr><td><table width="629" align="center">
								<tr><td height="31" colspan="4" class="normalbold"><b>Site Statistics</b></td>
								</tr>
								<tr>
								  <td width="73">&nbsp;</td>
								  <td width="184" class="seller style2">Total Members</td>
								<td width="3">:</td>
								<td width="349" class="normal"><span class="style2"><?php echo $totalmembers[0];?></span></td>
								</tr>
								<tr>
								  <td>&nbsp;</td>
							    <td class="seller style2">Total Sell Offers</td>
							    <td>:</td><td class="normal"><span class="style2"><?php echo $totelsell[0];?></span></td>
								</tr>
								<tr>
								  <td>&nbsp;</td>
							    <td class="seller style2">Total Buy Offers</td>
							    <td>:</td><td class="normal"><span class="style2"><?php echo $totalbuy[0];?></span></td>
								</tr>
								<tr>
								  <td>&nbsp;</td>
							    <td class="seller style2">Total Product Catelogs</td>
							    <td>:</td><td class="normal"><span class="style2"><?php echo $totalproduct[0];?></span></td>
								</tr>
								<tr>
								  <td>&nbsp;</td>
							    <td class="seller style2">Total Company Profiles</td>
