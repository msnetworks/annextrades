...
if(isset($_REQUEST['update']))
{
	...
	$our_security1=mysqli_real_escape_string($con, $_REQUEST['our_security1']);
	$our_security2=mysqli_real_escape_string($con, $_REQUEST['our_security2']);
	$our_security3=mysqli_real_escape_string($con, $_REQUEST['our_security3']);
	
	$qry=mysqli_query($con,"UPDATE cms SET our_security='$our_security' where cms_id='1'");
	$qry=mysqli_query($con,"UPDATE cms_french SET our_security='$our_security1' where cms_id='1'");
	//$qry=mysqli_query($con,"UPDATE cms_chinese SET our_security='$our_security2' where cms_id='1'");
	$qry=mysqli_query($con,"UPDATE cms_spanish SET our_security='$our_security3' where cms_id='1'");
	
	//header("location:cms.php?succ");			
	
	if($qry) { ?><script>
				window.location="cms_security.php?succ";
				</script><?php }
}
		...
		<div class="tab_container">
			...
			<form name="bulk_new" action="" method="post" onSubmit="return val();" >
				<input type="hidden" name="cms_id" value="<?php echo $cms_id ?>" />
					...
					<div class="de_lft" style="height:250px; width:100px;">Our Security&nbsp;&nbsp;(English)</div><div class="de_lft" style="width:300px;">
			<textarea cols="60" rows="10" name="our_security" id="our_security"><?php echo $sel_cms['our_security']; ?></textarea>
					</div>
					<div style="clear:both;"></div>
					
					<div class="de_lft" style="height:250px; width:100px;">Our Security&nbsp;&nbsp;(French)</div><div class="de_lft" style="width:300px;">
			<textarea cols="60" rows="10" name="our_security1" id="our_security1"><?php echo $sel_cms1['our_security']; ?></textarea>
					</div>
					<div style="clear:both;"></div>
					
					<?php /*?><div class="de_lft" style="height:250px; width:100px;">Our Security&nbsp;&nbsp;(Chinese)</div><div class="de_lft" style="width:300px;">
			<textarea cols="60" rows="10" name="our_security2" id="our_security2"><?php echo $sel_cms2['our_security']; ?></textarea>
					</div><?php */?>
					<div style="clear:both;"></div>
					<div class="de_lft" style="height:250px; width:100px;">Our Security&nbsp;&nbsp;(Spanish)</div><div class="de_lft" style="width:300px;">
			<textarea cols="60" rows="10" name="our_security3" id="our_security3"><?php echo $sel_cms3['our_security']; ?></textarea>
					</div>
					<div style="clear:both;"></div>	
