...
//session_start();
	...
	if(isset($_REQUEST['submit']))
	{
		...
		//header("Location:forummanagement.php?cid=$cid&edited");
		...
		<div class="tab_container">
			...
			<table width="98%" align="center" cellspacing="0" style="border:solid 1px #fff;">
				...
				<tr><td valign="top">
					...
					<table width="80%" height="266" align="center">
						<tr>
							<td width="108" height="57" class="inTxtNormal" style="font-size:12px;"><strong>Category Name&nbsp;&nbsp;(English)</strong></td>
						...
						<tr>
							<td width="108" height="53" class="inTxtNormal" style="font-size:12px;"><strong>Category Name&nbsp;&nbsp;(French)</strong></td>
						  	<td width="179"><input type="hidden" name="catid" value="<?php echo $catdetail1['id'];?>" /><input type="text" name="categoryname1" value="<?php echo $catdetail1['mainheading'];?>" style="width:200px;"/></td>
						</tr>
						<?php /*?><!--<tr>
							<td width="108" height="60" class="inTxtNormal" style="font-size:12px;"><strong>Category Name&nbsp;&nbsp;(Chinese)</strong></td>
						  	<td width="179"><input type="hidden" name="catid" value="<?php echo $catdetail2['id'];?>" /><input type="text" name="categoryname2" value="<?php echo $catdetail2['mainheading'];?>" style="width:200px;"/></td>
						</tr>--><?php */?>
						<tr>
							<td width="108" height="60" class="inTxtNormal" style="font-size:12px;"><strong>Category Name&nbsp;&nbsp;(Spanish)</strong></td>
						  	<td width="179"><input type="hidden" name="catid" value="<?php echo $catdetail3['id'];?>" /><input type="text" name="categoryname3" value="<?php echo $catdetail3['mainheading'];?>" style="width:200px;"/></td>
						</tr>
						<tr>
						  <td height="56" class="inTxtNormal" style="font-size:12px;"><strong>Parent Category</strong></td>
						  <td>
