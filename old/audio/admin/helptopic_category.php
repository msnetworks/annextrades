...
//session_start();
	...
	$sql=mysqli_query($con,"SELECT * FROM helptopic_category");
	if(isset($_REQUEST['delid']))
	{
	$id=$_REQUEST['delid'];
	$del=mysqli_query($con,"DELETE FROM helptopic_category WHERE id='$id'");
	$del=mysqli_query($con,"DELETE FROM helptopic_category_french WHERE id='$id'");
	//$del=mysqli_query($con,"DELETE FROM helptopic_category_chinese WHERE id='$id'");
	$del=mysqli_query($con,"DELETE FROM helptopic_category_spanish WHERE id='$id'");
	header("Location:helptopic_category.php?deleted");
	}
?>
...
return false;
	...
	<section id="main" class="column">
		...
		<h4 class="alert_success">Updated Sucessfully!</h4>
		<?php } ?>
				...
				<tr><td valign="top">
					...
					<table width="415" height="70" align="center" style="border:1px solid #E6E6E6;">
						...
						<tr>
						  ...
						  <td width="252">&nbsp;</td>
						  <td width="40">&nbsp;</td>
						  <td width="87"><a href="edithelptopic_category.php" class="gboldli" style="color:#000099;"><b>Add Category</b></a></td>
					  </tr>
					  ...
					  <?php while($row=mysqli_fetch_assoc($sql)){ ?>
						<tr><td class="gboldli">&nbsp;</td>
						  ...
						  <td><a href="addhelptopic_category.php?editid=<?php echo $row[id]; ?>"><img src="images/images (1).jpg" style="width:17px; height:17px;"/></a></td>
						  <td><a href="helptopic_category.php?delid=<?php echo $row[id]; ?>" onclick="return confirm('Are you sure do you want to delete this record?');"><img src="../images1/delete.jpg" alt="delete" title="delete" border="0" /></a></td>
						</tr>
						<?php } ?>
						<tr>
