...
//session_start();
	...
	$id=$_REQUEST['editid'];
	$sqlget=mysqli_query($con,"SELECT * FROM faq_question WHERE id='$id'");
	$row=mysqli_fetch_assoc($sqlget);
	
	$sqlget1=mysqli_query($con,"SELECT * FROM faq_question_french WHERE id='$id'");
	$row1=mysqli_fetch_assoc($sqlget1);
	
	//$sqlget2=mysqli_query($con,"SELECT * FROM faq_question_chinese WHERE id='$id'");
	//$row2=mysqli_fetch_assoc($sqlget2);
	
	$sqlget3=mysqli_query($con,"SELECT * FROM faq_question_spanish WHERE id='$id'");
	...
	if(isset($_REQUEST['editid'])){
	$sql=mysqli_query($con,"UPDATE faq_question SET `question`='$question' WHERE id='$id'");
	
	$sql=mysqli_query($con,"UPDATE faq_question_french SET `question`='$question1' WHERE id='$id'");
	
	//$sql=mysqli_query($con,"UPDATE faq_question_chinese SET `question`='$question2' WHERE id='$id'");
	
	$sql=mysqli_query($con,"UPDATE faq_question_spanish SET `question`='$question3' WHERE id='$id'");
	
	header("Location:faq.php?&upd=suc");
	}else{
	$sql=mysqli_query($con,"INSERT INTO faq_question(`question`)value('$question')");
	
	$sql=mysqli_query($con,"INSERT INTO faq_question_french(`question`)value('$question1')");
	
	//$sql=mysqli_query($con,"INSERT INTO faq_question_chinese(`question`)value('$question2')");
	
	$sql=mysqli_query($con,"INSERT INTO faq_question_spanish(`question`)value('$question3')");
	
	header("Location:faq.php?&add=suc");
	}
		...
		<div class="tab_container">
			...
			<table width="98%" align="left" cellspacing="0" >
				...
				<tr><td valign="top">
					...
					<table width="344" height="288" align="center" style="border:1px solid #E6E6E6;">
					  ...
					  <?php } ?>
						...
						<tr bgcolor="#E6E6E6">
						  <td colspan="3" height="20"><div align="center"><strong>Add Faq Subject </strong></div></td>
					  </tr>
						<tr>
						  <td width="22" class="gboldli">&nbsp;</td>
						  <td width="310"><a href="addnewfaq.php"></a> </td>
					  </tr>
						
						<tr>
						  <td height="27" class="gboldli">&nbsp;</td>
						   <td class="gboldli">&nbsp;</td>
						...
						<tr>
						  <td height="43" class="gboldli">English</td>
						  <td class="gboldli">&nbsp;</td>
						  <td><label>
					  ...
					  <tr>
						  <td height="43" class="gboldli">French</td>
						  <td class="gboldli">&nbsp;</td>
						  <td><label>
