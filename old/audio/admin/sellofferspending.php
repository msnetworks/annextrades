...
//session_start();
	...
	/*$sql="select * from tbl_seller where status='1' and user_id='$uid'";
	...
	$uid=addslashes(mysqli_real_escape_string($con, $_REQUEST['uid']));
	$strget="";
	$rowsPerPage = '20';
	$sql="select * from tbl_seller where status='1' and user_id='$uid' ";
			...
			<table width="98%" align="left" cellspacing="0" >
				...
				<tr><td height="358" valign="top">
					<table width="732" height="172" align="center" cellspacing="0">
						...
						<?php while($selling=mysqli_fetch_array($result)){
						...
						<td colspan="5">
							<table width="734" bgcolor="#FFFFFF">
							  <tr>
							  <?php /*?><td width="134" height="102"><img src="<?php echo $image;?>" width="98" height="86" /></td><?php */?>
							  <?php /*?><?php if($image == "") { ?>
							  <td width="134" height="102">nithya</td>
							  <?php } else { ?>
							  <td width="134" height="102"><img src="<?php echo $image;?>" width="98" height="86" /></td>
							  <?php } ?><?php */?>
							  <?php if($image == "") { ?>
							  <td><img src="images/no_image.jpg" style="width:75px; height:75px;" /></td>
							  <?php } else { ?>
							  <td><img src="<?php echo $image; ?>" style="width:75px; height:75px;" /></td>
							  <?php } ?>
							  <td width="172" valign="top" style="font-family:'Times New Roman', Times, serif; font-size:14px;"><?php echo $selling['seller_subject'];?></td>
							  ...
							  <td width="160" valign="top" style="font-family:'Times New Roman', Times, serif; font-size:14px;"><?php echo $selling['seller_updated_date'];?></td>
							  <!--<td width="78" valign="top"><a href="sell_leadshowuser.php?sid=<?php echo $selling['seller_id'];?>&uid=<?php echo $uid;?>">Show</a></td>-->
							  <td width="78" valign="top"><a href="sell_leadshowuser.php?sid=<?php echo $selling['seller_id'];?>&uid=<?php echo $uid;?>"><img src="images/view4.png" style="width:20px; height:20px;" /></a></td>
						 	</tr></table>
						 </td>
						</tr>
						<tr><td></td></tr>
