...
if(isset($_REQUEST['update']))
{
	...
	$protecting1=mysqli_real_escape_string($con, $_REQUEST['protecting1']);
	$protecting2=mysqli_real_escape_string($con, $_REQUEST['protecting2']);
	$protecting3=mysqli_real_escape_string($con, $_REQUEST['protecting3']);
	
	$qry=mysqli_query($con,"UPDATE cms SET protecting='$protecting' where cms_id='1'");
	$qry=mysqli_query($con,"UPDATE cms_french SET protecting='$protecting1' where cms_id='1'");
	//$qry=mysqli_query($con,"UPDATE cms_chinese SET protecting='$protecting2' where cms_id='1'");
	$qry=mysqli_query($con,"UPDATE cms_spanish SET protecting='$protecting3' where cms_id='1'");
	
	//header("location:cms.php?succ");			
	
	if($qry) { ?><script>
				window.location="cms_protect.php?succ";
				</script><?php }
}
		...
		<div class="tab_container">
			...
			<form name="bulk_new" action="" method="post" onSubmit="return val();" >
				<input type="hidden" name="cms_id" value="<?php echo $cms_id ?>" />
					...
					<div class="de_lft" style="height:250px; width:100px;">Protecting&nbsp;&nbsp;(English)</div><div class="de_lft" style="width:300px;">
			<textarea cols="60" rows="10" name="protecting" id="protecting"><?php echo $sel_cms['protecting']; ?></textarea>
					</div>
					<div style="clear:both;"></div>
					
					<div class="de_lft" style="height:250px; width:100px;">Protecting&nbsp;&nbsp;(French)</div><div class="de_lft" style="width:300px;">
			<textarea cols="60" rows="10" name="protecting1" id="protecting1"><?php echo $sel_cms1['protecting']; ?></textarea>
					</div>
					<div style="clear:both;"></div>
					
			<?php /*?>		<div class="de_lft" style="height:250px; width:100px;">Protecting&nbsp;&nbsp;(Chinese)</div><div class="de_lft" style="width:300px;">
			<textarea cols="60" rows="10" name="protecting2" id="protecting2"><?php echo $sel_cms2['protecting']; ?></textarea>
					</div>
					<div style="clear:both;"></div><?php */?>
					<div class="de_lft" style="height:250px; width:100px;">Protecting&nbsp;&nbsp;(Spanish)</div><div class="de_lft" style="width:300px;">
			<textarea cols="60" rows="10" name="protecting3" id="protecting3"><?php echo $sel_cms3['protecting']; ?></textarea>
					</div>
					<div style="clear:both;"></div>
