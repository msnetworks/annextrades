...
{
	$discuss_help=mysqli_real_escape_string($con, $_REQUEST['discuss_help']);
	$discuss_help1=mysqli_real_escape_string($con, $_REQUEST['discuss_help1']);
	$discuss_help2=mysqli_real_escape_string($con, $_REQUEST['discuss_help2']);
	$discuss_help3=mysqli_real_escape_string($con, $_REQUEST['discuss_help3']);
	
	
	$qry=mysqli_query($con,"UPDATE cms SET discuss_help='$discuss_help' where cms_id='1'");
	$qry=mysqli_query($con,"UPDATE cms_french SET discuss_help='$discuss_help1' where cms_id='1'");
	//$qry=mysqli_query($con,"UPDATE cms_chinese SET discuss_help='$discuss_help2' where cms_id='1'");
	$qry=mysqli_query($con,"UPDATE cms_spanish SET discuss_help='$discuss_help3' where cms_id='1'");
	
	//header("location:cms.php?succ");			
	
	if($qry) { ?><script>
				window.location="cms_discussion.php?succ";
				</script><?php }
}
		...
		<div class="tab_container">
			...
			<form name="bulk_new" action="" method="post" onSubmit="return val();" >
				<input type="hidden" name="cms_id" value="<?php echo $cms_id ?>" />
					...
					<div class="de_lft" style="height:250px; width:100px;">Discussion Help &nbsp;&nbsp;(English)</div><div class="de_lft" style="width:300px;">
			<textarea cols="60" rows="10" name="discuss_help" id="discuss_help"><?php echo $sel_cms['discuss_help']; ?></textarea>
					</div>
					
					<div style="clear:both;"></div>
						<div class="de_lft" style="height:250px; width:100px;">Discussion Help &nbsp;&nbsp;(French)</div><div class="de_lft" style="width:300px;">
			<textarea cols="60" rows="10" name="discuss_help1" id="discuss_help1"><?php echo $sel_cms1['discuss_help']; ?></textarea>
					</div>
					<div style="clear:both;"></div>
					
					<?php /*?><div class="de_lft" style="height:250px; width:100px;">Discussion Help &nbsp;&nbsp;(Chinese)</div><div class="de_lft" style="width:400px;"> 
					
			<textarea cols="60" rows="10" name="discuss_help2" id="discuss_help2"><?php echo $sel_cms2['discuss_help']; ?></textarea>
					
					</div>
					<div style="clear:both;"></div><?php */?>
					<div class="de_lft" style="height:250px; width:100px;">Discussion Help &nbsp;&nbsp;(Spanish)</div><div class="de_lft" style="width:400px;"> 
					
			<textarea cols="60" rows="10" name="discuss_help3" id="discuss_help3"><?php echo $sel_cms3['discuss_help']; ?></textarea>
