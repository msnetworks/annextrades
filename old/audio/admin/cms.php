...
if(isset($_REQUEST['update']))
{
	...
	$about_us1=mysqli_real_escape_string($con, $_REQUEST['about_us1']);
	$about_us2=mysqli_real_escape_string($con, $_REQUEST['about_us2']);
	$about_us3=mysqli_real_escape_string($con, $_REQUEST['about_us3']);
	
	$qry=mysqli_query($con,"UPDATE cms SET about_us='$about_us' where cms_id='1'");
	$qry=mysqli_query($con,"UPDATE cms_french SET about_us='$about_us1' where cms_id='1'");
	//$qry=mysqli_query($con,"UPDATE cms_chinese SET about_us='$about_us2' where cms_id='1'");
	$qry=mysqli_query($con,"UPDATE cms_spanish SET about_us='$about_us3' where cms_id='1'");
		...
		<div class="tab_container">
			...
			<form name="bulk_new" action="" method="post" onsubmit="return val();" >
				<input type="hidden" name="cms_id" value="<?php echo $cms_id ?>" />
					...
					<div class="de_lft" style="height:250px; width:100px;">About Us&nbsp;&nbsp;(English)</div><div class="de_lft" style="width:300px;">
			<textarea cols="60" rows="10" name="about_us" id="about_us"><?php echo $sel_cms['about_us']; ?></textarea>
					</div>
					<div style="clear:both;"></div>
					
					<div class="de_lft" style="height:250px; width:100px;">About Us&nbsp;&nbsp;(French)</div><div class="de_lft" style="width:300px;">
			<textarea cols="60" rows="10" name="about_us1" id="about_us1"><?php echo $sel_cms1['about_us']; ?></textarea>
					</div>
					<div style="clear:both;"></div>
					
					<?php /*?><div class="de_lft" style="height:250px; width:100px;">About Us&nbsp;&nbsp;(Chinese)</div><div class="de_lft" style="width:300px;">
			<textarea cols="60" rows="10" name="about_us2" id="about_us2"><?php echo $sel_cms2['about_us']; ?></textarea>
					</div>
					<div style="clear:both;"></div><?php */?>
						<div class="de_lft" style="height:250px; width:100px;">About Us&nbsp;&nbsp;(Spanish)</div><div class="de_lft" style="width:300px;">
			<textarea cols="60" rows="10" name="about_us3" id="about_us3"><?php echo $sel_cms3['about_us']; ?></textarea>
					</div>
					<div style="clear:both;"></div>
