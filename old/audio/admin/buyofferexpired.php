...
//session_start();
	...
	$strget="";
	$rowsPerPage = '20';
	$sql="select * from buyingleads where status='0' and id='$uid' order by buy_id desc ";
					...
					<table width="732" height="172" align="center" cellspacing="0">
						...
						<td colspan="5">
							<table width="734" bgcolor="#FFFFFF">
							  ...
							  <td width="78" valign="top"><a href="buyleadviewuser.php?bid=<?php echo $leads['buy_id'];?>&uid=<?php echo $uid;?>"><img src="images/view4.png" style="width:20px; height:20px;" /></a></td>
							  <?php /*?><td width="78" valign="top"><a href="buyleadviewuser.php?bid=<?php echo $leads['buy_id'];?>&uid=<?php echo $uid;?>">Show</a></td><?php */?>
						 	</tr></table>
						 </td>
						</tr>
						<tr><td></td></tr>
