...
if(isset($_REQUEST['update']))
{
	...
	$privacy_policy1=mysqli_real_escape_string($con, $_REQUEST['privacy_policy1']);
	$privacy_policy2=mysqli_real_escape_string($con, $_REQUEST['privacy_policy2']);
	$privacy_policy3=mysqli_real_escape_string($con, $_REQUEST['privacy_policy3']);
	
	
	$qry=mysqli_query($con,"UPDATE cms SET privacy_policy='$privacy_policy' where cms_id='1'");
	$qry=mysqli_query($con,"UPDATE cms_french SET privacy_policy='$privacy_policy1' where cms_id='1'");
	//$qry=mysqli_query($con,"UPDATE cms_chinese SET privacy_policy='$privacy_policy2' where cms_id='1'");
	$qry=mysqli_query($con,"UPDATE cms_spanish SET privacy_policy='$privacy_policy3' where cms_id='1'");
	
	//header("location:cms.php?succ");			
	
	if($qry) { ?><script>
				window.location="cms_privacy.php?succ";
				</script><?php }
}
		...
		<div class="tab_container">
			...
			<form name="bulk_new" action="" method="post" onSubmit="return val();" >
				<input type="hidden" name="cms_id" value="<?php echo $cms_id ?>" />
					...
					<div class="de_lft" style="height:250px; width:100px;">Privacy Policy&nbsp;&nbsp;(English)</div><div class="de_lft" style="width:300px;">
			<textarea cols="60" rows="10" name="privacy_policy" id="privacy_policy"><?php echo $sel_cms['privacy_policy']; ?></textarea>
					</div>
					<div style="clear:both;"></div>
					
					<div class="de_lft" style="height:250px; width:100px;">Privacy Policy&nbsp;&nbsp;(French)</div><div class="de_lft" style="width:300px;">
			<textarea cols="60" rows="10" name="privacy_policy1" id="privacy_policy1"><?php echo $sel_cms1['privacy_policy']; ?></textarea>
					</div>
					<div style="clear:both;"></div>
					<?php /*?>
					<div class="de_lft" style="height:250px; width:100px;">Privacy Policy&nbsp;&nbsp;(Chinese)</div><div class="de_lft" style="width:300px;">
			<textarea cols="60" rows="10" name="privacy_policy2" id="privacy_policy2"><?php echo $sel_cms2['privacy_policy']; ?></textarea>
					</div>
					<div style="clear:both;"></div><?php */?>
					<div class="de_lft" style="height:250px; width:100px;">Privacy Policy&nbsp;&nbsp;(Spanish)</div><div class="de_lft" style="width:300px;">
			<textarea cols="60" rows="10" name="privacy_policy3" id="privacy_policy3"><?php echo $sel_cms3['privacy_policy']; ?></textarea>
					</div>
					<div style="clear:both;"></div>	
