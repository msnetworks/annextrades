...
{
$select_cat="SELECT * FROM category WHERE parent_id='394' ORDER BY category ASC";
}
...
?>
    ...
    <div class="technology">
        <a href="products1.php?category=<?php echo $fetch_cat['c_id'];?>">
            <?php echo $fetch_cat['category'] ?>
        </a>
