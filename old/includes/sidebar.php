...
{
$select_cat="SELECT * FROM category WHERE parent_id=''  ORDER BY category ASC";
}
...
{ ?><li> <a href="products.php?cid=<?php echo $sel_subcate['c_id'];?>"><?php echo $sel_subcate['category']; ?></a>
            </li><?php } ?>
        </ul>
    </div>
    </div>
