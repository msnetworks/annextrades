    ...
    <td colspan="3" class="border_box"><table width="100%" border="0" cellpadding="3" cellspacing="2" style="border-bottom:1px solid #0075b0">
			  <tr><td colspan="2"></td></tr>
                ...
                <tr>
                  ...
                  <td class=""><?php echo $fname; ?><br />
                      <input name="fname" type="text" id="fname" value="<?PHP echo $fet['firstname'];?>"/></td>
                </tr>
                <tr>
...
I agree to&nbsp;<a href="javascript:popUp1('terms.php')" target="_self"><?php echo $membership_agreemant; ?></a><a href="javascript:popUp1('terms.php')" target="_self" class="topics2"></a>
