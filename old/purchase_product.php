...
{
$select = "SELECT * FROM `orders` WHERE user_id='$_SESSION[user_login]' and payment_status='1' order by id desc";
}
else if($_SESSION['language']=='french')
{
$select = "SELECT * FROM `tbl_seller` WHERE user_id='$_SESSION[user_login]' and payment_status='1'  order by id desc";
}
...
{
$fetch_product=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM `tbl_seller` where seller_id='$row[product_id]' order by seller_id desc"));
