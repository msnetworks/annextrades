...
<td width="100" ><strong style="padding-bottom:5px;"><a href="selling_view.php?id=<?php echo $fetch_app_pen['seller_id']; ?>"><span style=" padding-bottom:5px;"><?php echo $action; ?></span></a></strong>&nbsp;| &nbsp;<span style="padding-top:5px;"><a onclick="return delete_fun('<?php echo $fetch_app_pen['seller_id']; ?>','<?php echo $page;  ?>');"><img src="images/close1.png" width="20" height="20" style="padding-top:5px;"  /></a></span></td>
</tr>
</table>
<?php } } else { ?>
