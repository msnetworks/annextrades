                    ...
                    <div class="left">
                        <div style="border:1px solid #F0EFF0;" class="bordersty">
                            <form name="inbox" method="post" action="" onsubmit="return compare();">
                                ...
                                <div class="headinggg">Sended Quote Request <?php echo $_SESSION['vendor_id']; ?></div>
                                <div>
                                    <?php 
                                        ...
                                        $select="select * from getquote WHERE sender_vendor_id = '$vendor_id' order by id desc";
                                    ...
                                    <table border="0" width="100%" style="margin-top:8px;">
                                        ...
                                        <th>Product Name<!--?php echo $subject; ?--></th>
                                        <th>Status</th>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center" style="line-height:30px;"><?php echo $user_name; ?></td>
                                            ...
                                            <td align="center" style="line-height:30px;">
                                                <a style="color: red; font-weight: bold;" href="#"><?php echo "Reply"; ?></a>
                                            </td>
                                        </tr>
                                        <?php $i++; } ?>
