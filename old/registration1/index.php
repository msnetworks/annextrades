                                    ...
                                    <div class="row">
                                        ...
                                        <div id="msform">
                                            ...
                                            <fieldset <?php if($_GET['productinfo']=="Success"){ echo "style='display: none!important;'"; } ?>>
                                                ...
                                                <a href="controller/email_verify_resend.php?email=<?php echo $r['email']; ?>"><button type="button" style="font-weight: 800 !important; outline: 0px;  border-radius: 50px; padding: 17px; width: 32%; font-size: 19px; opacity: 5;" onclick="alert('Please Verify Email.');"  class="action-button" disabled><b>RESEND VERIFICATION EMAIL</b></button>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-9">
                                                            <div class="row">
                                                                ...
                                                                <?php
                                                                    $pq = $con->query("SELECT userid FROM product WHERE userid = '".$r['id']."'");
                                                                    ...
                                                                    <?php $i = 1;
                                                                    $pq1 = $con->query("SELECT * FROM product WHERE userid = '".$r['id']."'");
