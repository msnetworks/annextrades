...
$p_des = htmlspecialchars($pdes, ENT_QUOTES);
...

{
   ...
   //-----------Product Umage 4---------------
       if ($file_name4[$i] != "") {
           ...
           $response = print_r(error_get_last()); 
           $save = "../../productlogo/".$image5;   //This is the new file you saving
           $file = "../../productlogo/".$image5;   //This is the original file
           }    
       }
   
   $update=("INSERT INTO product SET userid = '$usr_id', p_name = '$p_name[$i]', p_keyword = '$p_name[$i]', p_min_quanity = '$quantities[$i]', range1 = '$prices[$i]', range2 = '$prices1[$i]', p_ddes = '$p_des', p_photo = '$image', photo1 = '$image', photo2 = '$image2', photo3 = '$image3', photo4 = '$image4', photo5 = '$image5'");
