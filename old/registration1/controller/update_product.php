...
for($i=0;$i<$count;$i++)
   ...
   //-----------Product Umage 5---------------
       if ($file_name4[$i] != "") {
        ...
        //print_r(error_get_last()); 
        $update= $con->query("UPDATE product SET p_name = '$p_name[$i]', p_keyword = '$p_name[$i]', p_min_quanity = '$quantities[$i]',p_quanity_type= '$p_quantity[$i]', range1 = '$prices[$i]', range2 = '$prices1[$i]', p_ddes = '$p_des', p_photo = '$image1', photo1 = '$image1', photo2 = '$image2', photo3 = '$image3', photo4 = '$image4', photo5 = '$image5' WHERE id = '$usr_id[$i]'");
