<?php 
    ...
    if(isset($_POST['submit']))
        ...
        move_uploaded_file($_FILES["photo1"]["tmp_name"], $ftimages5);
        ...
        `range2` = '$range2', `paymenttype` ='$payments', `p_min_quanity` = '$p_miniquantity', `p_quanity_type` = '$p_quantity', `p_capaacity` = '$p_capacity',
        ...
        if ($insertquery) {
            ...
            error_log();
            header("location:../my_products.php?fail");
        }
        }
