...
if(isset($_REQUEST['id']))
 ...
 $select_app_pen="SELECT * FROM product WHERE userid='$session_user' AND status='0' limit $start,$per_page ";
...
<span style="padding-top:5px;"><a onClick="return delete_pro3('<?php echo $fetch_app_pen['id']; ?>','<?php echo $page; ?>');"><img src="images/close1.png" width="20" height="20" style="padding-top:5px;"  /></a></span>
