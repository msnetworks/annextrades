                    ...
                    <div class="left">
                        <div style="border:1px solid #F0EFF0;" class="bordersty">
                            <form name="inbox" method="post" action="" onsubmit="return compare();">
                                ...
                                <div class="headinggg"><?php echo $inbox; ?>
                                </div>
                                <div>
                                    <?php 
                                        ...
                                        $select="select * from messages where from_mail not in (select contact_mail from add_contacts where status='1' and user_id='$session_user' ) and tostatus='0' and to_mail='$mail' order by id desc";
		...
		?>
                                        <tr>
                                            ...
                                            <td align="center" style="line-height:30px;"><a
                                                    href="inboxmsg.php?view=<?php echo $array_msg['id']; ?>"><b><?php echo $array_msg['subject']; ?></b></a>
                                            </td>
                                            <td align="center" style="line-height:30px;">
                                        ...
                                        <tr>
                                            <td align="center">
                                                ...
                                                <?php if($count_msg>0) { ?>
                                                <input type="submit" value="<?php echo $delete; ?>" name="delete"
                                                    class="search_bg" />
                                                <?php } ?>
                                            </td>
                                        </tr>
