...
?>
                ...
                <div class="container" style="padding: 0px;">
                    <div class="page-breadcrumb">
                        <ul class="list-unstyled">
                            <li><a href="service_categories.php"><?php if (!empty($catname->category)) : ?></li>
                            <li><a href="#"><?= $catname->category ?></a> > </li>
                            <?php endif; ?>
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="col-md-12" style="padding-bottom: 15px;">
                                        <h3 style="font-size: 24px;"><b><?php echo $result['p_name']; ?></b><br>
                                            <font style="font-size: 20px ;">by <font style="color: #2baae1;">
                                                <a STYLE="color: #2baae1 ;" id="abt" href="#about">
                                    ...
                                    <div class="col-md-5 single-section-1-left" >
                                            ...
                                            <div class="row1">
                                                <div class="col-md-12">
                                                    <div class="xzoom-container">
                                                        <img class="xzoom5" id="xzoom-magnific" style="max-height: 300px !important;" src="<?php echo "productlogo/" . $result['photo1']; ?>" xoriginal="<?php echo "productlogo/" . $result['photo1']; ?>" />
                                        ...
                                        <!-- <div class="col-md-5 single-section-1-left" style="padding-right: 15px;">
                                            <div class="row">        
                                                <div class="col-md-12 full-preview-image">
                                                ...
                                                <ul class="col-md-12 list-unstyled thumbs-wrap" style="margin: 8 0 0 0;">
                                                    <?php if (isset($result['photo1'])) { ?>
                                                    ...
                                                    <?php } if (isset($result['photo2'])) { ?>                                
                                                        ...
                                                        <li><?php if ((file_exists("productlogo/" . $result['photo2'])) && ($result['photo2']) != '') { ?><img src="<?php echo "productlogo/" . $result['photo2']; ?>" title="<?php echo $result['photo2'];?>" onclick="showImage('<?php echo $result['photo2'];  ?>');"/><?php } ?></li>

                                                    <?php } if (isset($result['photo3'])) { ?>
                                                        <li><?php if ((file_exists("productlogo/" . $result['photo3'])) && ($result['photo3']) != '') { ?><img src="<?php echo "productlogo/" . $result['photo3']; ?>" title="<?php echo $result['photo3'];?>" onclick="showImage('<?php echo $result['photo3'];  ?>');" /><?php }  ?></li>

                                                    <?php  } if (isset($result['photo4'])) { ?>
                                                        <li><?php if ((file_exists("productlogo/" . $result['photo4'])) && ($result['photo4']) != '') { ?><img src="<?php echo "productlogo/" . $result['photo4']; ?>" title="<?php echo $result['photo4'];?>" onclick="showImage('<?php echo $result['photo4'];  ?>');" /><?php } ?></li>

                                                    <?php  } if (isset($result['photo5'])) { ?>
                                                        <li><?php if ((file_exists("productlogo/" . $result['photo5'])) && ($result['photo5']) != '') { ?><img src="<?php echo "productlogo/" . $result['photo5']; ?>" title="<?php echo $result['photo5'];?>" onclick="showImage('<?php echo $result['photo5'];  ?>');" /><?php } ?></li>
                                                    <?php }?>
                                                </ul> 
                                            </div>   
                                        </div> -->
                                    </div>
                                    <div class="col-md-7 single-section-1-center">
                                        
                                        <div class="rating-wrap">
                                            <img class="star-rating" src="./assets/images/stars-<?= $reviewAvg ?>.png" alt=""> <span><?= $reviewAvg ?> <a style="color: #2baae1;" href="#rating">Rating</a></span>
                                        </div><br>
                                        <div class="text3"style="/* height: 100px; overflow:hidden; */">
                                            <h5 style="color: #2baae1 !important;"><b>Service Description</b></h5><br>
                                            <div class="text-justify">
                                                <p>
                                                    <?php echo htmlspecialchars_decode(html_entity_decode($bdes))."..."; ?>
                                                </p>
                                            </div><br>
                                        </div>
                                        <div class="read-more-btn pull-right">
                                            <a STYLE="color: #2baae1 ;" id="moreinfo" href="#about"><b>More Info <i class="fa fa-long-arrow-right" aria-hidden="true"></i></b></a>
                                        </div>
                                        <ul class="list-unstyled col-three text-center w-100">
                                            <li class="col-md-4 text-left">
                                                <b><?php echo (($result['p_price'] == 'USD' || $result['p_price'] == '') ? '$' : $result['p_price']) . "" . formatPrice($result['range1']) . " - " . formatPrice($result['range2']); ?>/-</b>
                                                <?php if (isset($result['p_min_quanity']) && !empty($result['p_min_quanity'])) : ?>
                                                    <p class="m-0"><?php /* echo $result['p_min_quanity']; */ ?> Estimated Price</p><?php endif; ?>
                                            </li>
                                            <li class="col-md-4">
                                        ...
                                        <h5 style="color: #2baae1 !important;"><b>Supplier Information</b></h5><br>
                                        <ul class="list-unstyled col-three text-center w-100">
                                            <li class="col-md-4 text-left">
                                        ...
                                        <div>
                                            <?php if(isset($sess_id)){ ?><a class="theme-btn" style="background: #2baae1 !important;" href="proaction1.php?id=<?php echo $result['id']; ?>">CONTACT NOW</a>  <?php }else{ ?><a class="theme-btn" style="background: #2baae1 !important;" href="login-page.php?id=<?php echo $result['id']; ?>">CONTACT NOW</a>  <?php } ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 single-section-2-right" style="background: #f1f1f1; padding: 15px;">
                                ...
                                <form action="" method="post" >
                                    ...
                                    <?php
                                        if ($_SESSION['user_login'] == '') {
                                    ?>
                                       <button style="outline: none; background: #2baae1; color: #fff;" id="gq" class="theme-btn text-center">GET QUOTE</button>
                                       <script>
                                            $("#gq").click(function(){
                                    ...
                                    <?php } else{ ?>
                                        <input type="submit" name="submit_quote" style="background: #2baae1;" class="theme-btn text-center" value="GET QUOTE" />
                                    <?php } ?>
                            ...
                            <div class="company-tabs-wrapper">
                                ...
                                <ul class="nav" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link active" id="product-detail-tab" data-toggle="tab" href="#product-detail" role="tab" aria-controls="product-detail" aria-selected="true">Service Description</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="product-detail" role="tabpanel">
                                        <!-- <h2 class="tab-title">Service Description</h2> -->
                                        <div class="col-md-12">
                                            <p>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            if(!empty($result['p_ddes'])) {
                                                ...
                                                echo html_entity_decode($result['p_ddes']);
                                    ...
                                    <div class="tab-pane fade" id="about-company" role="tabpanel">
        ...
        <div class="modal fade" id="add-review-modal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <form method="post" action="controller/productreview.php?id=<?php echo $_GET['id'];?>&amp;cid=<?php echo $_GET['cid'];?>&amp;scid=<?php echo $_GET['scid'];?>&amp;type=service" id="reviewForm">
