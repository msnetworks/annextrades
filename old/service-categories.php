	...
	<div class="container">
		<?php while ($fetch_cat = mysqli_fetch_array($res_cat)) { ?>
			...
			<div class="row-title-header">
				...
				<div><a href="services.php?category=<?= $fetch_cat['c_id'] ?>" style="background: #288E66 !important;" class="view-all-btn">View All</a></div>
			</div>
				...
				<?php while ($product = mysqli_fetch_array($productsData)) { ?>
					...
					<div class="item-box">
						...
						<div class="item-box-info">
							<h6><a href="servicecompanyinfo.php?id=<?php echo $product['id']; ?>&amp;cid=<?php echo $product['p_category']; ?>&amp;scid=<?php echo $product['p_subcategory']; ?>"><?php echo $product['p_name']; ?></a></h6>
							<div class="item-desc">
