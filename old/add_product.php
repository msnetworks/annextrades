                ...
                <div class="tabs-cont">
                    <div class="left">
                        <div style="border:1px solid #F0EFF0;" class="bordersty">
                            ...
                            <form id="form1" name="product" method="post" action="controller/add_product.php" enctype="multipart/form-data"
                                onsubmit="return validate(this);">
                                <input type="text" name="userid" value="<?php echo $session_user?>" hidden>
                                <div class="p-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea name="p_bdes" id="p_bdes"></textarea>
                                        <script>
                                    ...
                                    <div class="input-group">
                                        <table cellpadding="0" cellspacing="0" width="100%" id="dataTable">
                                            <tr>
                                                ...
                                                <td width="314">
                                                    <input type="file" name="clg_0" id="clg0" size="40" value="" onKeyDown="return chkkeycode(event,this.id)" class="textarea" />
                                                    <div id="b_0_err" style="display:none; color:#FF3300;">
                                                    </div>
                                                </td>
                                                <td width="268">
                                                <img src="plus_icon.png" border="0" onClick="addRow_new('dataTable','clg','clgfrm','clgto')"title="Add New Point" /></td>
                                            </tr>
                                        </table>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea name="detail_description" id="detail_description" class=""
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td colspan="2" style="border-bottom:1px #CCCCCC solid; font-size:14px; font-weight:bold;">Add Category
                    / Subcategory </td>
                <td style="border-bottom:1px #CCCCCC solid; float:right;"> 
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td colspan="2" style="border-bottom:1px #CCCCCC solid; font-size:14px; font-weight:bold;">Add
                    Subcategory </td>
                <td style="border-bottom:1px #CCCCCC solid; float:right;"> 
                    <img src="images/icn_alert_error.png" onclick="document.getElementById('light1').style.display='none';document.getElementById('fade1').style.display='none';"
