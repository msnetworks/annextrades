...
$select_buy="SELECT * FROM buyingleads where id='$session_user' and status='0' and trash = 0 limit $start,$per_page ";
...
<td width="100" ><strong style="padding-bottom:5px;"><a href="buying_view.php?id=<?php echo $fetch_buy['buy_id']; ?>"><span style=" padding-bottom:5px;"><?php echo $action; ?></span></a></strong> &nbsp;| &nbsp;<span style="padding-top:5px;"><!--<a onClick="return delete_buy('<?php echo $fetch_buy['buy_id']; ?>','<?php echo $page; ?>');">--><a onClick="return delete_new2('<?php echo $fetch_buy['buy_id']; ?>','<?php echo $page; ?>');"><img src="images/close1.png" width="20" height="20" style="padding-top:5px;"  /></a></span></td>
</tr>
</table>
<?php } } else { ?>
