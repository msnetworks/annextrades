...
/*var length=document.companyrate.rate.length;
    for (var i=0; i<length; i++) 
	{
    	if(document.companyrate.rate[i].checked)
		{
		  var check=document.companyrate.rate[i].value;
 		}
	} 
if(check=="")
{
...
if(document.companyrate.rate[0].checked==false && document.companyrate.rate[1].checked==false && document.companyrate.rate[2].checked==false && document.companyrate.rate[3].checked==false && document.companyrate.rate[4].checked==false)
	{
	alert("Please Select Atleast One Radiobutton");
	return false;
	}
}
</script>
...
<table width="100%" height="198" border="0" cellpadding="0" cellspacing="0"  >
           ...
           <!-- <tr>
			...
			<tr>
              <td width="8%" height="26">&nbsp;</td>
              <td height="26" colspan="3">(5: <?php echo $dream_com; ?>, 4: <?php echo $desirable; ?>, 3: <?php $good; ?>, 2: <?php echo $ok; ?>, 1: <?php echo $stay_away; ?>)</td>
              </tr>
			  <tr>
              <td width="8%" height="26">&nbsp;</td>
              <td height="26" colspan="3"><input name="rate" type="radio" value="5" />5
                <input name="rate" type="radio" value="4" />4
                <input name="rate" type="radio" value="3" />3
                <input name="rate" type="radio" value="2" />2
                <input name="rate" type="radio" value="1" />1</td>
              </tr>
            <tr>
              <td height="33" colspan="4" align="center"><input name="Submit" type="<?php echo $submit; ?>" class="search_bg" value="Submit">&nbsp;&nbsp;<a href="javascript:self.close();" class="bluueboldli2">
                <input type="submit" name="Submit2" class="search_bg" value="Close" onclick="javascript:self.close();"/>
                </a></td>
            </tr>
            <tr>
