                                       ...
                                       <td width="76%" valign="top">
                                          <table width="100%">
                                             <tr>
                                                ...
                                                <td height="25"><a class="browse_intext" href="tradeshow_search.php?id=<?php echo $fetch['show_id'];?>"><strong><?php echo $showname; ?></strong></a>&nbsp;&nbsp;<?php echo $fetch['seller_updated_date']; ?></td>
                                             </tr>
                                             <tr>
