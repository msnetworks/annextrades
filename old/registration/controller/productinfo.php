...

{
   ...
   $insert=("INSERT INTO product SET userid = '$usr_id', p_name = '$p_name', p_keyword = '$p_name',p_category = '1938', p_subcategory = '1939', p_min_quanity = '$quantities[$i]', p_quanity_type= '$p_quantity[$i]', range1 = '$prices[$i]', range2 = '$prices1[$i]', p_ddes = '$p_des', p_photo = '$image', photo1 = '$image', photo2 = '$image2', photo3 = '$image3', photo4 = '$image4', photo5 = '$image5', status='1', udate = '$date', expiredate = '$expiredate' ");
