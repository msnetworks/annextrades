...
if(!isset($_SESSION['user_login'])){ //if login in session is not set
...
require 'PHPMailer/src/SMTP.php';
	...
	$sel_sql="select * from `featureproducts` where id='$sellid'";
	$res_sel=mysqli_query($con,$sel_sql);
	$result_sel=mysqli_fetch_array($res_sel);
	$com_res=$result_sel['companyname'];
	$email=$result_sel['companyemail'];
	
if(isset($_POST['Submit_form_send']))
{
	...
	$subject_send1=$_POST['subject'];
	$message_send1=$_POST['message'];
	$price=$_POST['price'];
...
"<table width='550' cellpadding='0' cellspacing='0' border='0' bgcolor='#F2F1F1' style='border:solid 10px #25ABC4;'>
  ...
  <tr bgcolor='#FFFFFF' height='35'>
    <td style='padding-left:20px; font-family:Arial; font-size:11px; line-height:18px; text-decoration:none; color:#000000;'>Detail description:</td>
  </tr>
  <tr bgcolor='#FFFFFF' height='35'>
    <td style='padding-left:20px; font-family:Arial; font-size:11px; line-height:18px; text-decoration:none; color:#000000;'>$message_send1</td>
  </tr>
  <tr bgcolor='#FFFFFF' height='35'>
...
//$mail->AltBody = 'This is the plain text version of the email content';
  ...
  if(!$mail->Send()) {
         ...
         echo "<script type='text/javascript'>alert('Message has not been sent. Try again.');</script>";
       // echo '<script type="text/javascript">alert("Mailer Error: $mail->ErrorInfo");</script>';
     } else {
     	//echo  $sql = "INSERT INTO notificaton (user_id, seller_id, form_status) VALUES ('$userid', '$sellid', 0)";
     	//$sql= "INSERT INTO notification (user_id, seller_id, form_status) VALUES ('$userid', '$sellid', '0')";
     	//$res_qry=mysqli_query($con,$sql) or die("insert error");
                                    ...
                                    <td><form action="" method="post" enctype="multipart/form-data" name="buying" id="buying" onsubmit="return validate(this)">
                                      ...
                                      <table width="100%" height="457"  border="0"  cellpadding="2" cellspacing="2" align="center">
                                        ...
                                        <tr>
                                          ...
                                          <td width="74%"><?php echo $com_res;?> </td>
                                        </tr>
                                        <tr>
											...
											<a href="javascript:openClosStatus('reqHead');" class="">)</a>
                                              <div id="reqHead" style="display:none"> &nbsp;&nbsp;
                                                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                      <th width="35%" valign="top" align="right" style="padding-right:20px;"><span class="bluebold">Price & Terms:</span></th>
                                                      <td width="74%">
													  	<table align="left" border="0" cellpadding="0" cellspacing="2" width="44%">
                                                          <tr>
                                                            <td height="30" nowrap="nowrap"><span class="bluebold">Incoterm</span>
														...
														<tr>
                                                            <td height="30" nowrap="nowrap"><span class="bluebold">Payment </span>
                                                    ...
                                                    <tr>
                                                      <th align="right" valign="top" style="padding-right:20px;"><font class="redbold">* </font><span class="bluebold">Initial Order Quantity : </span></th>
                                                      <td valign="middle">
                                                    ...
                                                    <tr>
                                                      <th align="right" style="padding-right:20px;"><span class="bluebold">Sample Terms:</span></th>
                                                      <td colspan="3">
