...
<div style="border:1px solid #CCCCCC;" class="bordersty">
	...
	<table border="0" width="100%" style="margin-top:8px;">
		...
		<th width="183"><a href="#" class="bTxtM2" onclick="javascript:SetAllCheckBoxes('contact_list', 'check_list[]', true)"><?php echo $select_all; ?></a>&nbsp;/&nbsp;<a href="#" class="bTxtM2" onClick="javascript:SetAllCheckBoxes('contact_list', 'check_list[]', false)" ><?php echo $clear_all; ?></a></th>
		<th width="234"><?php echo $contact_name; ?></th>
		<th width="223"><?php echo $company_name; ?></th>
		<th width="173"><?php echo $type; ?></th>
		<th width="138"><?php echo $country1; ?></th>
		<?php
		...
		<tr>
			...
			<td align="center"><input type="checkbox"  name="check_list[]" value="<?PHP echo $array['contact_id']; ?>" id="check_list[<?PHP echo $i;?>]"/></td>
			...
			?>
			<td align="center" style="line-height:30px;"><?php echo $row['country_name'];  ?></td>
		</tr>
	...
	<table>
		<tr>
			...
			<td>
			<?php if($num_rows>0) { ?>
			<input type="submit" class="search_bg" name="Insert" value="<?php echo $Insert; ?>" />
			<?php } ?>
			</td>
		</tr>
	</table>
