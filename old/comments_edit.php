...
<div class="products-cate-heading">Add Your Comments</div>
...
<form id="form1" name="form1" method="post" action="">
	...
	<tr>
		<td><span style="color:#FF0000;">*</span><b>&nbsp;Comments</b></td>
		<td><textarea name="msg" rows="3" cols="40"></textarea></td>
	</tr>
	<tr>
		<td colspan="2" align="center" style="padding-top:10px;"><input type="submit" name="Submit" class="search_bg" value="Post" onclick="return checkval();"/></td>
	</tr>
</form>	
</table>
