                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">List of Registration</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12"><h5>Registration List</h5></div>
                                    ...
                                    <table class="table table-striped table-bordered first" id="myTable" border="1">
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                $sql = "SELECT * FROM registration ORDER BY id DESC LIMIT $offset, $no_of_records_per_page";
