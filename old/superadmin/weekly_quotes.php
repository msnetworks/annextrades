                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title"><i class="fa fa-comments"></i> Weekly Deals List</h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Dashboard</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">List of Weekly Deals</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12"><h5>Weekly Deals Quote</h5></div>
                            ...
                            <div class="card-header">
                                <div class="col-md-12">
                                    <label for="myInput"><b>Search Weekly Deals:</b> </label><input type="text" class="form-control" id="myInput" onkeyup="myFunction()" placeholder="Type keywords.." title="Type in a name"><br>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first" id="myTable">
                                        ...
                                        <tbody>
                                            <?php 
                                            $query1=mysqli_query($conn, "SELECT * FROM productsend  order by msg_id desc");
                                            WHILE($row_adv1=mysqli_fetch_array($query1)){
                                            ?>
                                            
                                            <?php 
                                                $quyb1=mysqli_query($conn, "SELECT * FROM registration where id = '".$row_adv1['userid']."'");
                                                $rows1=mysqli_fetch_array($quyb1);
                                            ?>
                                            <?php 
                                                $quyb1=mysqli_query($conn, "SELECT * FROM product where id = '".$row_adv1['productid']."'");
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo $row_adv1['msg_id']; ?></td>
                                                <td><a target="_blank" href="edit_newproduct.php?product_id=<?php echo $row_adv1['productid'];?>&id=<?php echo $rowp1['userid'];?>"><?php echo $rowp1['p_name'];?></a></td>
                                                ...
                                                <td><?php echo $row_adv1['enterdate'];?></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                        <!--tfoot>
