...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center"><a href="https://annextrades.com"><img class="logo-img" src="https://annextrades.com/assets/images/logo.png" alt="logo" width="200px"></a></div>
            <h5 class="splash-description">User Login</h5>
            <span class="splash-description">Please enter your login information.</span>
            <div class="card-body">
