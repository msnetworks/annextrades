...
CREATE TABLE IF NOT EXISTS `<DB_PREFIX>logs` (
  ...
  `referer_url` varchar(255) COLLATE utf8_unicode_ci NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `<DB_PREFIX>proxy-settings` (
  ...
  `api1` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `api2` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `api3` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `logging` tinyint(1) NOT NULL DEFAULT '1',
  `autoban` tinyint(1) NOT NULL DEFAULT '0',
