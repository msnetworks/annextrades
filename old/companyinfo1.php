...
<div class="products-cate-heading"> <?php echo ucfirst($result['subject']);?></div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                        ...
                        <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="border_box" >
                                        ...
                                        <td><table width="100%" >
                                            ...
                                            <tr>
                                              <td width="36%" ><table width="100%" height="63">
                                                  <tr>
                                                    <td height="48" align="center"><?php if((file_exists("uploads/".$result['photo']))&&($result['photo']!='')) { ?><img src="<?php echo "uploads/".$result['photo'];?>" height="125" width="125"/><?php } else { ?><img src="upload/img_noimg.jpg" height="125" width="125"/><?php } ?></td>
                                                  </tr>
                                              </table></td>
							...
							?>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td width="64%" class="labeltext"><?php echo $result['update_date'];?></td>
                                                  </tr>
                                                 <!-- <tr>
                                                    <td width="54%" class="labelname"><strong><?php echo $product_model; ?> :</strong></td>
                                                    <td width="46%" class="labeltext"><?php echo $result['keyword'];?></td>
                                                  </tr>-->
                                                  <tr>
                                                    <td class="labelname"><strong><?php echo $expiry_date; ?> :</strong></td>
                                                    <td class="labeltext"><?php echo $result['expiredate'];?></td>
                                                  </tr>
                                                  <tr>
                                                    <td width="54%" class="labelname" valign="top"><strong><?php echo $product_descrip; ?> : </strong></td>
                                                    <td width="46%" class="labeltext"><?php echo $result['briefdes']; ?></td>
                                                  </tr>
                                              </table></td>
                                            </tr>
                                        </table></td>
					...
					?>
					"send_action.php?id=<?php echo $result['buy_id'];?>"
					<?php 
					}
					}else{ 
					?>"login.php" 
