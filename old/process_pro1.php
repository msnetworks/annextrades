...
$select_app_pen="SELECT * FROM product WHERE userid='$session_user' AND status='3' limit $start,$per_page ";
...
<span style=" padding-bottom:5px;"><?php echo $view; ?></span></a></strong> 
&nbsp;| &nbsp; <a href="edit_product.php?id=<?php echo $fet_edit['id']; ?>"><span style=" padding-bottom:5px; font-weight:bold;"><?php echo $edit; ?></span></a>&nbsp;| &nbsp;
<span style="padding-top:5px;"><a onClick="return delete_pro1('<?php echo $fetch_app_pen['id']; ?>','<?php echo $page; ?>');"><img src="images/close1.png" width="20" height="20" style="padding-top:5px;"  /></a></span>
