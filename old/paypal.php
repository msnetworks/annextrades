...
$ins_ord=mysqli_query($con,"insert into member_order (order_refid,order_userid,order_packid,order_packname,order_name,order_email,order_price,order_date,order_ip,payment_status) values ('$random_req_id','$sess_id','$pay','$membership_type','$user_name','$user_email','$amount',NOW(),'$ip_addr','0')");
...
$up_ord=mysqli_query($con,"update member_order set order_refid='$random_req_id',order_packid='$pay',order_packname='$membership_type',order_name='$user_name',order_email='$user_email',order_price='$amount',order_date=NOW(),order_ip='$ip_addr',payment_status='0' where order_userid='$sess_id'");
