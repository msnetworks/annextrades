        ...
        <div class="" style="background: #F7F7F7 !important;">
            ...
            <div class="container">
                ...
                <div class="col-lg-8">
                    ...
                    <!-- Preview Image -->
                    <img class="img-fluid rounded w-100 shdw zmin" style="height: 300px;" src="asset/img/feature/<?php echo $row['image'];?>" alt="">
                ...
                <div class="col-md-4 pd-0 mr-0" style="background: #fbfbfb;">                    
                    ...
                    <section class="mr-tp-30 bdr-0">
                        <div class="wrap15">
                            <div class="title-divider mr-bt-30 pd-bt-30">
                                <h1 class="hdr" style="font-family: 'lora'">Subscribe Newslatter</h1>
                                <!--div class="divider-arrow"></div-->
                            </div>
