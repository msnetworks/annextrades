...
<div class="products-cate-heading"><?php echo $articles; ?></div>
<div style="border: solid 1px #CFCFCF;">

<table border="0" width="100%" style="padding-top:10px; padding-left:5px;">
	<tr>
		<td width="42%"><b><?php echo $subject; ?></b></td>
		<td width="36%"><b><?php echo $update_date; ?></b></td>
		<td width="22%"><b><?php echo $number_post; ?></b></td>
	</tr>
	<?php
		$select="select * from mainarticles";
		...
		if($count>0)
		{
			...
			{  
				$id=$row['id'];
				$res=mysqli_query($con,"select * from articles where mainarticlesid='$id'");
				$num=mysqli_num_rows($res);
	?>
	<tr>
		<td><a href="articles_new.php?id=<?php echo $row['id'];?>"><?php echo $row['articles']; ?></a></td>
