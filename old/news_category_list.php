    ...
    <div class="projects-clean" style="background: rgba(255,255,255,0) !important;">
        <div class="projects-horizontal">
            <div class="container">
                ...
                <?php
                        $run   = mysqli_query($connect, "SELECT * FROM `posts` WHERE category_id='$category_id' and active='Yes' ORDER BY views DESC ");
                    ...
                    <div class="col-sm-6 item zmin">
                        <div class="row">
                            <div class="col-md-12 col-lg-5"><a href="news_details.php?id=<?php echo $row['id']; ?>"><img class="img-fluid" src="asset/img/news/<?php echo $row['image'];?>"></a></div>
                            <div class="col">
