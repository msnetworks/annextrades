            ...
            <div class="tabs-cont" style="margin-top:0">
                <div class="left">
                    <div class="p-2" style="padding-top:0">
                        <div class="products-cate-heading"><h5><?php echo $posting_rules; ?></h5>
                        </div>
...
{
$select=mysqli_query($con,"select posting_rule_help from cms");
}
else if($_SESSION['language']=='french')
{
$select=mysqli_query($con,"select posting_rule_help from cms_french");
}
else if($_SESSION['language']=='chinese')
{
$select=mysqli_query($con,"select posting_rule_help from cms_chinese");
}
else
{
$select=mysqli_query($con,"select posting_rule_help from cms_spanish");
}
	
	$gen=mysqli_fetch_array($select);
?>
                                <tr>
                                    <td style="padding-left:10px;"><?php echo $gen['posting_rule_help']; ?></td>
                                </tr>
                            </form>
                        </table>
                    </div>
