...
<td width="150"><strong><?php echo $fetch_approve['p_name']; ?></strong></td>
<td width="150"><strong><?php echo substr($fetch_approve['p_bdes'],0,50)."...";?></strong></td>
<td width="150"><strong><?php echo $fetch_approve['udate']; ?></strong></td>
