...
function popUp1(URL) {
    ...
    eval("page" + id + " = window.open(URL, '" + id +
        "', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=0,width=400,height=150,left = 150,top = 234');"
        );
}
                ...
                <div class="tabs-cont">
                    <div class="left" style="border:1px solid #F0EFF0; border-radius:5px;">
                        <div class="bordersty">
                            ...
                            <div class="headinggg"><strong>Membership Details <?php /* echo $member_details; */ ?></strong></div>
                            ...
                            <form id="buying" name="buying" method="post" action="" enctype="multipart/form-data"
                                ...
                                <table width="100%" border="1" bordercolor="#29B1C9" align="right" cellpadding="0"
                                    cellspacing="0">
                                    <tr>
                                        <td>
                                                                    ...
                                                                    <table width="100%" border="0" cellpadding="2"
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" colspan="2">
                                                                                <strong>Gold membership information <?php /* echo $gold_member_info; */ ?></strong>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="text_mem" align="left">
                                                                                <strong>By getting this level membership you can:<?php /* echo $mambership_bylvl; */?></strong>
                                                                            </td>
                                                                            <td rowspan="4" valign="middle">
                                                                                <?php 
                                                                                    if(($select_fet['order_packname'] == "GoldSupplier") and ($select_fet['payment_status']=='1')) {
                                                                                ?>
                                                                                <span>Post each product in many Categories<?php /* echo $gold_supplier; */ ?></span>
                                                                                <?php
} else {
?>

                                                                                <input type="button" class="search_bg"
                                                                                    name="gold"
                                                                                    onclick="change_mem('GoldSupplier')"
                                                                                    value="Upgrade<?php /* echo $upgrade;  */?>" />
                                                                                <?php } ?>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="text_mem">
                                                                                <strong><?php echo $getting_level_member; ?>:</strong>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="text_mem">&nbsp;&nbsp;
                                                                                <table border="0" cellpadding="2"
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td><?php echo $product_many_categories; ?>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td>&nbsp;&nbsp;<?php echo $add_image_product; ?>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
...
?>
                                                                                ...
                                                                                <input type="button" class="search_bg"
                                                                                    name="silver"
                                                                                    onclick="change_mem('SilverSupplier')"
                                                                                    value="<?php echo $upgrade; ?>" />
                                                                                <?php } ?>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td class="text_mem">
                                                                                &nbsp;&nbsp;<?php echo $mambership_addimg;?>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="text_mem">
                                                                                &nbsp;&nbsp;<?php echo $details['sillver_year'];?>
                                                                                <?php echo $year; ?> -
                                                                                <?php echo $amount; ?> $.
                                                                                <?php echo $details['silver_amount'];?>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td colspan="2">&nbsp;</td>
                                                            ...
                                                            <tr>
                                                                <td style="border:3px solid #29B1C9;">
                                                                    <table width="100%" border="0" cellpadding="2"
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" colspan="2">
                                                                                <strong><?php echo $bonze_member_info; ?></strong>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="text_mem">
...
?>
                                                                                <input type="button" class="search_bg"
                                                                                    name="bronze"
                                                                                    onclick="change_mem('bronzeSupplier')"
                                                                                    value="<?php echo $upgrade; ?>" />
                                                                                <?php } ?>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="text_mem">
                                                                                &nbsp;&nbsp;<?php echo $product_many_categories; ?>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="text_mem">
                                                                                &nbsp;&nbsp;<?php echo $add_image_product; ?>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="text_mem">
                                                                                &nbsp;&nbsp;<?php echo $details['bronze_year'];?>
                                                                                <?php echo $year; ?> -
                                                                                <?php echo $amount; ?> $.
                                                                                <?php echo $details['bronze_amount'];?>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td colspan="2">&nbsp;</td>
...
?>
                                                                    <a
                                                                        href="javascript:popUp1('upmember.php?id=<?php echo $select_fet['id'];?>')">
                                                                        <input type="submit" name="Input"
                                                                            value="<?php echo $mambership_upgrd;?>"
                                                                            class="search_bg"
                                                                            onclick="javascript:popUp1('upmember.php?id=<?php echo $select_fet['id'];?>')" />
                                                                        <img src="images/bu_upgradeNow.gif" width="141"
                                                                            height="29" border="0" />
                                                                    </a>
                                                                    <?php
}
