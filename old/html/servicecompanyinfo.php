                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="col-md-12" style="padding-bottom: 15px;">
                                        <h3 style="font-size: 24px;"><b><?php echo $result['p_name']; ?></b><br>
                                            <font style="font-size: 20px ;">by <font style="color: #2baae1;">
                                                <a STYLE="color: #2baae1 ;" href="#about">
                                    ...
                                    <div class="col-md-4 full-preview-image w-25" style="height: 100%; padding:;">
                                        <?php if (isset($result['photo1'])) { ?>
                                            <?php if ((file_exists("productlogo/" . $result['photo1'])) && ($result['photo1']) != '') { ?>
                                                <img id="currentImg" src="<?php echo "productlogo/" . $result['photo1']; ?>" /><?php } else { ?><img src="productlogo/img_noimg.jpg" />
                                            <?php } ?>
                                        <?php } ?>
                                    </div>
                                    <script>
                                    ...
                                    <div class="col-md-8 single-section-1-center">
                                        
                                        <div class="rating-wrap">
                                            <img class="star-rating" src="./assets/images/stars-<?= $reviewAvg ?>.png" alt=""> <span><?= $reviewAvg ?> Rating</span>
                                        </div><br>
                                        <div style="height: 100px;">
                                        <h5 style="color: #2baae1 !important;"><b>Product Description</b></h5><br>
                                            <div class="text3">
                                                <?php echo $result['p_bdes']; ?>
                                            </div><br>
                                            <div class="read-more-btn pull-right">
                                                <a STYLE="color: #2baae1 ;" href="#about"><b>Read More <i class="fa fa-long-arrow-right" aria-hidden="true"></i></b></a>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-3 single-section-2-right" style="background: #f1f1f1; padding: 15px;">
                                ...
                                <form action="" method="post" >
                                    ...
                                    <div class="form-group">
                                        <input type="email" placeholder="Email" class="form-control" value="<?php echo $gemail; ?>" name="youremail" required>
                                    </div>
                                
                                    <div class="form-group">
                                        <input type="text" placeholder="Number" class="form-control" name="phone" required>
                                    </div>
