...
<td width="100" ><strong style="padding-bottom:5px;"><a href="product_view.php?id=<?php echo $fetch_app_pen['id']; ?>"><span style=" padding-bottom:5px;"><?php echo $view; ?></span></a></strong>&nbsp;| &nbsp;<strong style="padding-bottom:5px;"><a href="edit_product.php?id=<?php echo $fetch_app_pen['id']; ?>"><span style=" padding-bottom:5px;"><?php echo $edit; ?></span></a></strong>&nbsp;| &nbsp;<span style="padding-top:5px;"><a onClick="return delete_pro('<?php echo $fetch_app_pen['id']; ?>','<?php echo $page; ?>');"><img src="images/close1.png" width="20" height="20" style="padding-top:5px;" title="delete" /></a></span></td>
</tr>
</table>
