					...
					<table width="732" height="157" align="center" cellspacing="0">
						...
						<td colspan="5">
							...
							<table width="457" align="center">
								...
								<tr valign="top"><td width="145" height="30"><b>Selling Lead Type</b></td>
							    <td width="10"><b>:</b></td>
							    <td width="286"><?php echo $details['seller_leadtype'];?></td>
								</tr>
								<tr valign="top"><td width="145" height="29"><b>Product Name</b></td>
							    <td width="10"><b>:</b></td>
							    <td width="286"><?php echo $details['seller_subject'];?>
							      <input type="hidden" name="sid" value="<?php echo $details['seller_id'];?>" /></td>
								</tr>
								<tr valign="top"><td height="28"><b>Keywords</b></td>
								<td><b>:</b></td>
								...
								<tr valign="top"><td height="28"><b>Country</b></td>
								<td><b>:</b></td>
								...
								<tr valign="top">
								  <td height="28"><b>Detailed Description</b></td>
								  <td><b>:</b></td>
								<td><?php echo $details['seller_detaildescription'];?></td>
								</tr>
								<tr valign="top"><td height="31"><b>Valid for</b></td>
								<td><b>:</b></td>
								<td><?php echo $details['seller_valid'];?> months</td>
								</tr>
								<tr valign="top"><td height="40"><b>Seller Company Name</b></td>
								<td><b>:</b></td>
								<td><?php echo $details['seller_companyname'];?></td>
								</tr>
								<tr valign="top"><td height="40"><b>Seller Bussiness Type</b></td>
								<td><b>:</b></td>
								<td><?php echo $details['seller_businesstype'];?></td>
								</tr>
								<tr valign="top">
								  <td height="40"><b>Seller Bussiness Range</b></td>
								<td><b>:</b></td>
								...
								<tr valign="top"><td height="33"><b>Updated Date</b></td>
								<td><b>:</b></td>
								<td><?php echo $details['seller_updated_date'];?></td>
								</tr>
								<tr valign="top"><td height="32"><b>Expiry Date</b></td>
								<td><b>:</b></td>
								...
								<tr><td colspan="3" align="center"><input type="submit" onclick="history.go(-1);" value="Back" /></td></tr>
						  </table>
						  </form>
						 </td>
						</tr>
