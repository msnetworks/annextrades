...
//session_start();
	...
	$sqlget=mysqli_query($con,"SELECT `buy_over` FROM general");
	$sqlget1=mysqli_query($con,"SELECT `buy_over` FROM general_french");
	//$sqlget2=mysqli_query($con,"SELECT `buy_over` FROM general_chinese");
	$sqlget3=mysqli_query($con,"SELECT `buy_over` FROM general_spanish");
	...
	{
		//$buy_over = addslashes($_POST['buy_over']);
		 $buy_over=mysqli_real_escape_string($con, $_POST['buy_over']);
	     $buy_over1=mysqli_real_escape_string($con, $_POST['buy_over1']);
	     $buy_over2=mysqli_real_escape_string($con, $_POST['buy_over2']);
		 $buy_over3=mysqli_real_escape_string($con, $_POST['buy_over3']);
		$sqll=mysqli_query($con,"SELECT buy_over FROM general");
		$sql2=mysqli_query($con,"SELECT `buy_over` FROM `general_french`");
	   // $sql3=mysqli_query($con,"SELECT `buy_over` FROM `general_chinese`");
		 $sql4=mysqli_query($con,"SELECT `buy_over` FROM `general_spanish`");
	   ...
	   // $check2=mysqli_num_rows($sql3);
		...
		if(($check > 0) && ($check1 > 0) && ($check3 > 0)){
			$sql=mysqli_query($con,"UPDATE general SET buy_over = '$buy_over'");
	        $sql=mysqli_query($con,"UPDATE general_french SET `buy_over`='$buy_over1'");
	       // $sql=mysqli_query($con,"UPDATE general_chinese SET `buy_over`='$buy_over2'");
			$sql=mysqli_query($con,"UPDATE general_spanish SET `buy_over`='$buy_over3'");

		}else{
			$sql=mysqli_query($con,"INSERT INTO general(buy_over) values ('$buy_over')");
			 $sql=mysqli_query($con,"INSERT INTO general_french(`buy_over`)value('$buy_over1')");
	        //$sql=mysqli_query($con,"INSERT INTO general_chinese(`buy_over`)value('$buy_over2')");
			$sql=mysqli_query($con,"INSERT INTO general_spanish(`buy_over`)value('$buy_over3')");
		}
		header("Location:buy_over.php?updated");
	}
?>
...
return false;
	...
	<section id="main" class="column">
		...
		<header><h3 class="tabs_involved">Buy Overview</h3><h2 style="padding-top:7px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:history.back(-1);" style="color:#009900;">Back</a></h2>
		</header>
			...
			<table width="98%" align="left" cellspacing="0" >
				...
				<tr><td valign="top">
					...
					<div><strong>English</strong></div>
						<tr bgcolor="#E6E6E6">
						  <td colspan="2" height="20"><div align="center"><strong>Buy Overview</strong></div></td>
					  </tr>
						<tr>
						...
						<tr>
						  <td class="gboldli">&nbsp;</td>
						  <td><label>
						    <textarea name="buy_over"><?php echo stripslashes($row['buy_over']); ?></textarea>
						  </label></td>
					  </tr>
					...
					<div><strong>French</strong></div>
						...
						<tr>
						  <td class="gboldli">&nbsp;</td>
						  <td><label>
						    <textarea name="buy_over1"><?php echo stripslashes($row1['buy_over']); ?></textarea>
						  </label></td>
					  </tr>
						<tr><td class="gboldli">&nbsp;</td>
						  <td>&nbsp;</td>
					...
					<?php /*?><div><strong>Chinese</strong></div>
						...
						<tr>
						  <td class="gboldli">&nbsp;</td>
						  <td><label>
						    <textarea name="buy_over2"><?php echo stripslashes($row2['buy_over']); ?></textarea>
						  </label></td>
					  </tr>
						<tr><td class="gboldli">&nbsp;</td>
						  <td>&nbsp;</td>
					...
					<div><strong>Spanish</strong></div>
						...
						<tr>
						  <td class="gboldli">&nbsp;</td>
						  <td><label>
						    <textarea name="buy_over3"><?php echo stripslashes($row3['buy_over']); ?></textarea>
						  </label></td>
					  </tr>
						<tr><td class="gboldli">&nbsp;</td>
						  <td>&nbsp;</td>
