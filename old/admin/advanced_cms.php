...
{
	$community_help=mysqli_real_escape_string($con, $_REQUEST['community_help']);
	$community_help1=mysqli_real_escape_string($con, $_REQUEST['community_help1']);
	$community_help2=mysqli_real_escape_string($con, $_REQUEST['community_help2']);
	$community_help3=mysqli_real_escape_string($con, $_REQUEST['community_help3']);
	
	
	$qry=mysqli_query($con,"UPDATE cms SET community_help='$community_help' where cms_id='1'");
	$qry=mysqli_query($con,"UPDATE cms_french SET community_help='$community_help1' where cms_id='1'");
	//$qry=mysqli_query($con,"UPDATE cms_chinese SET community_help='$community_help2' where cms_id='1'");
	$qry=mysqli_query($con,"UPDATE cms_spanish SET community_help='$community_help3' where cms_id='1'");
	
	//header("location:cms.php?succ");			
	
	if($qry) { ?><script>
				window.location="advanced_cms.php?succ";
				</script><?php }
}
		...
		<div class="tab_container">
			...
			<form name="bulk_new" action="" method="post" onsubmit="return val();" >
				<input type="hidden" name="cms_id" value="<?php echo $cms_id ?>" />
					...
					<div class="de_lft" style="height:250px; width:100px;">Community Help &nbsp;&nbsp;(English)</div><div class="de_lft" style="width:300px;">
			<textarea cols="60" rows="10" name="community_help" id="community_help"><?php echo $sel_cms['community_help']; ?></textarea>
					</div>
					
					<div style="clear:both;"></div>
						<div class="de_lft" style="height:250px; width:100px;">Community Help &nbsp;&nbsp;(French)</div><div class="de_lft" style="width:300px;">
			<textarea cols="60" rows="10" name="community_help1" id="community_help1"><?php echo $sel_cms1['community_help']; ?></textarea>
					</div>
					<div style="clear:both;"></div>
					
					<?php /*?><div class="de_lft" style="height:250px; width:100px;">Community Help &nbsp;&nbsp;(Chinese)</div><div class="de_lft" style="width:400px;"> 
					
			<textarea cols="60" rows="10" name="community_help2" id="community_help2"><?php echo $sel_cms2['community_help']; ?></textarea>
					
					</div>
					<div style="clear:both;"></div><?php */?>
					<div class="de_lft" style="height:250px; width:100px;">Community Help &nbsp;&nbsp;(Spanish)</div><div class="de_lft" style="width:400px;"> 
					
			<textarea cols="60" rows="10" name="community_help3" id="community_help3"><?php echo $sel_cms3['community_help']; ?></textarea>
