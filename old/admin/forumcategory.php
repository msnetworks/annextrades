...
//session_start();
	...
	if(isset($_REQUEST['submit']))
	{
		...
		header("Location:forummanagement.php?added");
	}
?>
		...
		<div class="tab_container">
			...
			<table width="98%" align="center" cellspacing="0" style="border:solid 1px #fff;">
				...
				<tr><td valign="top">
					...
					<table width="80%" height="215" align="center">
						<tr>
							<td width="108" height="46" class="inTxtNormal" style="font-size:12px;"><strong>Category Name &nbsp;&nbsp;(English)</strong></td>
						  	<td width="179"><input type="text" name="categoryname" class="inTxtNormal" style="width:200px; height:18px;"/></td>
						</tr>
						<tr>
							<td width="108" height="45" class="inTxtNormal" style="font-size:12px;"><strong>Category Name &nbsp;&nbsp;(French)</strong></td>
						  	<td width="179"><input type="text" name="categoryname1" class="inTxtNormal" style="width:200px; height:18px;"/></td>
						</tr>
						<!--<tr>
							<td width="108" height="34" class="inTxtNormal" style="font-size:12px;"><strong>Category Name &nbsp;&nbsp;(Chinese)</strong></td>
						  	<td width="179"><input type="text" name="categoryname2" class="inTxtNormal" style="width:200px; height:18px;"/></td>
						</tr>-->
						<tr>
							<td width="108" height="34" class="inTxtNormal" style="font-size:12px;"><strong>Category Name &nbsp;&nbsp;(Spanish)</strong></td>
						  	<td width="179"><input type="text" name="categoryname3" class="inTxtNormal" style="width:200px; height:18px;"/></td>
						</tr>
						<tr>
						  <td height="50" class="inTxtNormal" style="font-size:12px;"><strong>Parent Category</strong></td>
						  <td>
							<select name="parentcategory" class="inTxtNormal" style="width:200px;">
								<option value="0">Root</option>
								<?php
								while($category=mysqli_fetch_array($result))
								{
								?>
								<option value="<?php echo $category['id'];?>"><?php echo $category['mainheading'];?></option>
								<?php }?>
							</select>
						</td></tr>
