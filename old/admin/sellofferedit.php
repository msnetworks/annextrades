...
//session_start();
	...
	$strget="";
	$rowsPerPage = '20';
	$sql="select * from tbl_seller where status='3' and user_id='$uid' ";
	$result=mysqli_query($con,getPagingQuery1($sql, $rowsPerPage,$strget));
	$pagingLink = getPagingLink1($sql, $rowsPerPage,$strget); 
	$count = mysqli_num_rows(mysqli_query($con,$sql));
					...
					<table width="732" height="172" align="center" cellspacing="0">
						...
						<td colspan="5">
							<table width="734" bgcolor="#FFFFFF">
							  ...
							  <td width="78" valign="top"><a href="sell_leadshowuser.php?sid=<?php echo $product['seller_id'];?>&uid=<?php echo $uid;?>"><img src="images/view4.png" style="width:20px; height:20px;" /></a></td>
							  <?php /*?><td width="78" valign="top"><a href="sell_leadshowuser.php?sid=<?php echo $product['seller_id'];?>&uid=<?php echo $uid;?>">Show</a></td><?php */?>
						 	</tr></table>
						 </td>
						</tr>
						<tr><td></td></tr>
