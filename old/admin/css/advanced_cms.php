...
if(isset($_REQUEST['update']))
{
	...
	$qry=mysqli_query($con,"UPDATE cms SET community_help='$community_help', add_comments='$add_comments',discuss_help='$discuss_help',posting_rule_help='$posting_rule_help' where cms_id='1'");
		...
		<div class="tab_container">
			...
			<form name="bulk_new" action="" method="post" onsubmit="return val();" >
				<input type="hidden" name="cms_id" value="<?php echo $cms_id ?>" />
					...
					<div class="de_lft" style="height:250px; width:100px;">Community Help</div><div class="de_lft" style="width:300px;">
			<textarea cols="60" rows="10" name="community_help" id="community_help"><?php echo $sel_cms['community_help']; ?></textarea>
					</div>
					
					<div style="clear:both;"></div>
						<div class="de_lft" style="height:250px; width:100px;">Comments</div><div class="de_lft" style="width:300px;">
			<textarea cols="60" rows="10" name="add_comments" id="add_comments"><?php echo $sel_cms['add_comments']; ?></textarea>
					</div>
					<div style="clear:both;"></div>
					
					<div class="de_lft" style="height:250px; width:100px;">Discussion Help</div><div class="de_lft" style="width:400px;"> 
			...
			<textarea cols="60" rows="10" name="discuss_help" id="discuss_help"><?php echo $sel_cms['discuss_help']; ?></textarea>
					...
					<div class="de_lft" style="height:250px; width:100px;">Posting Help Rule</div><div class="de_lft" style="width:400px;"> 
