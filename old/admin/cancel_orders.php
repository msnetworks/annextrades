...
if($_REQUEST['del_id'])
{
	...
	if($del)
	{
	header("location:cancel_orders.php?del");
	}
}

if(isset($_REQUEST['reset']))
{
header("location:cancel_orders.php?datepicker=&tospicker=&product=&sort=&search=Search");
}
...
<link href="css/core-inetdir1.css" rel="stylesheet" type="text/css" />
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="dashboard.php">Website Admin</a> <div class="breadcrumb_divider"></div> <a href="#"><b>Cancel Orders</b></a></article>
		</div>
	...
	<section id="main" class="column">
		...
		<header><h3 class="tabs_involved">Cancel Orders</h3>
		</header>
		<div class="tab_container">
			...
			<tr><td align="center">
				...
				<tr><td><form name="searchform" method="get" action="cancel_orders.php" onsubmit="return val_search();">
			...
			<!--<tr><td height="34" colspan="2" align="center"><a href="sellingexcl.php?key=<?php echo $keyword;?>&show=<?php echo $show;?>" class="news"><span style="font-size:13px">Export Sellers list in Excel Format</span></a></td></tr>-->
				...
				<tr><td height="358" valign="top" colspan="9">
					<table width="100%" align="center" cellspacing="0">
						...
						<td width="13%" class="normalbold">&nbsp;&nbsp;Order Status</td>
...
//echo "select * from orders where order_status!=2 $strval"; 
           $select="select * from orders where order_status=1 $strval";
			  ...
			  $count=mysqli_num_rows($query);
				...
				<!--<td width="140" height="102" align="center"><img src="<?php echo $image;?>" width="98" height="86" /></td>-->
						...
						<!--	  <td width="16%" valign="top" style="font-family:'Times New Roman', Times, serif; font-size:13px;">&nbsp;<?php /*?><?php if($selling['trans_id']!="") { echo $selling['trans_id']; } else { echo "Nil"; }?><?php */?></td>-->
							  ...
							  <td width="13%" valign="top" style="font-size:13px;">&nbsp;<?php if($selling['order_status']=="1")
							  {
							...
							echo "Cancelled";
							 ...
							 <a href="cancel_orders.php?del_id=<?php echo $selling['id'];?>" onclick="return confirm('Are you sure you wish to delete this record?');" style="text-decoration:none;">&nbsp;&nbsp;<img src="../images1/delete.jpg" alt="Delete" title="Delete" border="0" /></a></td>
