...
if(isset($_REQUEST['update']))
{
	...
	$terms_conditions1=mysqli_real_escape_string($con, $_REQUEST['terms_conditions1']);
	$terms_conditions2=mysqli_real_escape_string($con, $_REQUEST['terms_conditions2']);
	$terms_conditions3=mysqli_real_escape_string($con, $_REQUEST['terms_conditions3']);
	
	
	$qry=mysqli_query($con,"UPDATE cms SET terms_conditions='$terms_conditions' where cms_id='1'");
	$qry=mysqli_query($con,"UPDATE cms_french SET terms_conditions='$terms_conditions1' where cms_id='1'");
	//$qry=mysqli_query($con,"UPDATE cms_chinese SET terms_conditions='$terms_conditions2' where cms_id='1'");
	$qry=mysqli_query($con,"UPDATE cms_spanish SET terms_conditions='$terms_conditions3' where cms_id='1'");
	
	//header("location:cms.php?succ");			
	
	if($qry) { ?><script>
				window.location="cms_terms.php?succ";
				</script><?php }
}
		...
		<div class="tab_container">
			...
			<form name="bulk_new" action="" method="post" onSubmit="return val();" >
				<input type="hidden" name="cms_id" value="<?php echo $cms_id ?>" />
					...
					<div class="de_lft" style="height:250px; width:100px;">Terms of Use &nbsp;&nbsp;(English)</div><div class="de_lft" style="width:300px;">
			<textarea cols="60" rows="10" name="terms_conditions" id="terms_conditions"><?php echo $sel_cms['terms_conditions']; ?></textarea>
					</div>
					<div style="clear:both;"></div>
					
					<div class="de_lft" style="height:250px; width:100px;">Terms of Use &nbsp;&nbsp;(French)</div>
					<div class="de_lft" style="width:300px;">
			<textarea cols="60" rows="10" name="terms_conditions1" id="terms_conditions1"><?php echo $sel_cms1['terms_conditions']; ?></textarea>
					</div>
					<div style="clear:both;"></div>
					
					<?php /*?><div class="de_lft" style="height:250px; width:100px;">Terms of Use &nbsp;&nbsp;(Chinese)</div><div class="de_lft" style="width:300px;">
			<textarea cols="60" rows="10" name="terms_conditions2" id="terms_conditions2"><?php echo $sel_cms2['terms_conditions']; ?></textarea>
					</div>
					<div style="clear:both;"></div><?php */?>
					<div class="de_lft" style="height:250px; width:100px;">Terms of Use &nbsp;&nbsp;(Spanish)</div><div class="de_lft" style="width:300px;">
			<textarea cols="60" rows="10" name="terms_conditions3" id="terms_conditions3"><?php echo $sel_cms3['terms_conditions']; ?></textarea>
					</div>
					<div style="clear:both;"></div>	
