...
if(!isset($_SESSION['admin_user']))
	...
	if($_REQUEST['delid'])
    {
		...
		mysqli_query($con,"delete from productsend where msg_id='$delid'");
	}
?>
...
function confirm_delete()
{
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="dashboard.php">Website Admin</a> <div class="breadcrumb_divider"></div> <a class="current">Product Enquiry</a></article>
		</div>
	...
	<section id="main" class="column">
		...
		<header><h3 class="tabs_involved">Product Enquiry</h3>
		<!--<ul class="tabs">
...
if($count>0)
{
			  ...
			  while($sel_cou = mysqli_fetch_array($result))
			  {
				...
				<tr> 
					...
					<td nowrap="nowrap" style="margin: 0; padding: 0; border-bottom: 1px dotted #ccc; "><a href="enquiryreply.php?id=<?php echo $uid;?>" style="color:#000099;" ><b><?php echo $res['email'];?></a></b></td>
					<td nowrap="nowrap" style="margin: 0; padding: 0; border-bottom: 1px dotted #ccc; ">
						<?php
							$pselect=mysqli_fetch_array(mysqli_query($con,"select * from product where id='$pid'"));
							echo $sub=$pselect['p_name'];
						?>
					</td>	
					...
					<td nowrap="nowrap" style="margin: 0; padding: 0; border-bottom: 1px dotted #ccc; "><a href="enquiryview.php?product&id=<?php echo $sel_cou['msg_id'];?>" class="news"><img src="images/view4.png" style="width:20px; height:20px;" /></a>
					<a href="productenquiry.php?delid=<?PHP echo $sel_cou['msg_id'];?>" class="redboldlink" onclick="return confirm('Are you sure want to delete this record?');"><img src="../images1/delete.jpg" border="0" /></a></td>
				</tr> 
