...
session_start();
	...
	if(isset($_REQUEST['submit']))
	{
		...
		$membertype=$_REQUEST['membershiptype'];
				
		if($_REQUEST['searchin']=="username")
		{
		//echo "select * from registration where firstname like '%$keyword%' and membershiptype like '%$membertype%'";exit;
		echo $sql="select * from registration where (firstname LIKE '%$keyword%' OR user_name LIKE '%$keyword%') and membershiptype like '%$membertype%'";
		}
		else if($_REQUEST['searchin']=="company")
		{
			echo $sql="select * from registration where companyname like '%$keyword%'";
		}
	}
	else
	{
		$sql="select * from registration order by last_visit_date desc";
	}
	$result=mysqli_query($con,getPagingQuery1($sql, $rowsPerPage,$strget)) or die(mysqli_error($con));
	$pagingLink = getPagingLink1($sql, $rowsPerPage,$strget); 
	$count = mysqli_num_rows(mysqli_query($con,$sql));
			...
			<table width="98%" align="center" cellspacing="0">
				<tr><td width="53%" height="129">
					...
					<table width="367" align="center" cellpadding="0" cellspacing="0" border="0">
						<tr class="normal"><td width="105" height="37">&nbsp;&nbsp;Keyword</td>
						<td width="12">:</td>
						<td width="320"><input type="text" name="keyword"/></td></tr>
						<tr class="normal"><td width="105" height="37">&nbsp;&nbsp;Type</td>
						<td width="12">:</td>
						<td width="320"><input name="membershiptype" type="radio" value="GoldSupplier" />
						Gold
				...
				</td><td width="47%"><table width="100%" cellpadding="0" cellspacing="0" border="0">
				<tr><td width="53%" height="25"><strong>Report</strong></td>
				</tr>
				<?php
				...
				$freereg=mysqli_query($con,"select * from registration where membershiptype='free'");
				...
				?>
				<tr><td class="normal" height="25">No. Active Members  : <?php echo $actnum;?></td>
				<td width="47%" class="normal">Free Members : <?php echo $freenum;?></td>
				</tr>
				<tr><td class="normal" height="25">No. Deactive Members: <?php echo $datnum;?></td>
				<td class="normal">Gold Members : <?php echo $goldnum;?></td>
				</tr>
				<tr><td class="normal" height="25"><a href="memexcl.php" class="news">Export This Members</a></td>
				<td class="normal">Silver Members : <?php echo $silvernum;?></td>
				</tr>
				...
				<tr><td height="358" valign="top" colspan="2">
					<table width="732" height="79" align="center" cellspacing="0" style="border:1px solid #fff;">
						<tr bgcolor="#D8F1E4">
					  <td height="29" align="left" colspan="3" bgcolor="#99CCFF">&nbsp;&nbsp;<strong>All Members</strong></td>
						...
						<tr class="smallfont">
						  <td>
							  <table width="100%" style="border-bottom:1px solid #99CCFF;">
								  <tr><td width="245">&nbsp;<strong><?php echo $members['email'];?></strong></td>
								    <td width="162"><strong><?php echo $members['firstname'];?></strong></td>
									<td width="151"><strong>Currently <font color="#339966"><?php echo $members['membershiptype'];?></font></strong></td>
									<td width="150"><strong>Offers Posted</strong></td>
								</tr>
								<tr>
									<td>&nbsp;Join Date :  <?php echo $members['date'];?></td>
						...
						<?php }?>
						<tr><td colspan="3" align="center" height="35"><a href="memexcl.php?key=<?php echo $keyword;?>&searchin=<?php echo $searchin;?>" class="news">Export This Members</a></td></tr>
						<?php if($count>$rowsPerPage){?>
						<tr><td colspan="3" align="center"><?php echo $pagingLink;?></td></tr><?php }?>
