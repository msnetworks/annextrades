...
function confirm_delete()
{
	...
	<section id="main" class="column">
		...
		<h4 class="alert_success">Forum Category Edited Successfully</h4>
		<?php } ?>
		...
		<header><h3 class="tabs_involved">Forum Category</h3><h2 style="padding-top:7px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="forumcategory.php" style="color:#009900;">New Category</a></h2>
		<!--<ul class="tabs">
...
cursor: pointer;"> 
			...
			$sql="select * from forumheading where parentid='0' order by mainheading asc ";
...
if($count>0)
{
			  ...
			  ?>
				<tr> 
					...
					<td nowrap="nowrap"><a href="forumsubcategory.php?cid=<?php echo $sel_cou['id'];?>" style="color:#000099;"><b><?php echo $sel_cou['mainheading']; ?></b></a></td>
					<td nowrap="nowrap"><a href="editforumcategory.php?cid=<?php echo $sel_cou['id']; ?>"><img src="images/images (1).jpg" style="width:17px; height:17px;"/></a>
					&nbsp;&nbsp;<a href="forummanagement.php?delete=<?php echo $sel_cou['id']; ?>" onclick="return confirm_delete();"><img src="images/delete2.jpg" /></a></td>
				</tr> 
