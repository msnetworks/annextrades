...
//session_start();
	...
	$strget="";
	$rowsPerPage = '20';
	$sql="select * from tbl_seller where status='0' and user_id='$uid' ";
						...
						<td colspan="5">
							<table width="734" bgcolor="#FFFFFF">
							  ...
							  <td width="160" valign="top" style="font-family:'Times New Roman', Times, serif; font-size:14px;"><?php echo $product['seller_updated_date'];?></td>
							   <td width="78" valign="top" ><a href="sell_leadviewuser.php?sid=<?php echo $product['seller_id'];?>&uid=<?php echo $uid;?>"><img src="images/view4.png" style="width:20px; height:20px;" /></a></td>
							 <?php /*?> <td width="78" valign="top"><a href="sell_leadviewuser.php?sid=<?php echo $product['seller_id'];?>&uid=<?php echo $uid;?>">Show</a></td><?php */?>
						 	</tr></table>
						 </td>
						</tr>
						<tr><td></td></tr>
