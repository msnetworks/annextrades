		...
		<div class="tab_container">
			...
			<thead> 
				<tr  style="background-color:#CCCCCC;"> 
    				...
    				<th width="115">Category Name</th> 
					<th width="151">Image</th>
					<th width="137">Subcategory</th>
...
if($count>0)
{
			  ...
			  ?>
				<tr> 
					...
					<td align="center"><img src="../images/img_noimg.jpg" width="50" height="50" /></td>
					<?php } else { ?>
					<td align="center"><img src="category_images/<?php echo $sel_cou['cat_image']; ?>" width="50" height="50" /></td>
					<?php } ?>
					<td nowrap="nowrap" align="center"><a href="sub_category.php?catid=<?php echo $cid; ?>"><b style="color:#047AB6;">Subcategory</b></a></td>
					<td width="99" nowrap="nowrap" align="center"><a href="edit_category.php?catid=<?php echo $cid; ?>"><img src="images/images (1).jpg" style="width:17px; height:17px;"/></a>
