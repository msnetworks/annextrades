...
//session_start();
	...
	$sqlget=mysqli_query($con,"SELECT `help_reg` FROM general");
	$sqlget1=mysqli_query($con,"SELECT `help_reg` FROM general_french");
	//$sqlget2=mysqli_query($con,"SELECT `help_reg` FROM general_chinese");
	$sqlget3=mysqli_query($con,"SELECT `help_reg` FROM general_spanish");
	...
	{
		//$help_reg = addslashes($_POST['help_reg']);
		$help_reg=mysqli_real_escape_string($con, $_POST['help_reg']);
	    $help_reg1=mysqli_real_escape_string($con, $_POST['help_reg1']);
	    $help_reg2=mysqli_real_escape_string($con, $_POST['help_reg2']);
		$help_reg3=mysqli_real_escape_string($con, $_POST['help_reg3']);
		$sqll=mysqli_query($con,"SELECT help_reg FROM general");
		$sql2=mysqli_query($con,"SELECT `help_reg` FROM `general_french`");
	    //$sql3=mysqli_query($con,"SELECT `help_reg` FROM `general_chinese`");
		$sql4=mysqli_query($con,"SELECT `help_reg` FROM `general_spanish`");
	...
	if(($check > 0) && ($check1 > 0) && ($check3 > 0)) {
			...
			$sql=mysqli_query($con,"UPDATE general_french SET `help_reg`='$help_reg1'");
	        //$sql=mysqli_query($con,"UPDATE general_chinese SET `help_reg`='$help_reg2'");
			$sql=mysqli_query($con,"UPDATE general_spanish SET `help_reg`='$help_reg3'");
		}else{
			$sql=mysqli_query($con,"INSERT INTO general(help_reg) values ('$help_reg')");
			$sql=mysqli_query($con,"INSERT INTO general_french(`help_reg`)value('$help_reg1')");
	       // $sql=mysqli_query($con,"INSERT INTO general_chinese(`help_reg`)value('$help_reg2')");
			$sql=mysqli_query($con,"INSERT INTO general_spanish(`help_reg`)value('$help_reg3')");
		}
		header("Location:help_reg.php?updated");
	}
?>
...
return false;
	...
	<section id="main" class="column">
		...
		<header><h3 class="tabs_involved">Registration Help</h3><h2 style="padding-top:7px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:history.back(-1);" style="color:#009900;">Back</a></h2>
		</header>
			...
			<table width="98%" align="left" cellspacing="0" >
				...
				<tr><td valign="top">
					...
					<div><strong>English</strong></div>
						<tr bgcolor="#E6E6E6">
						  <td colspan="2" height="20"><div align="center"><strong>Registration Help</strong></div></td>
					  </tr>
						<tr>
						...
						<tr>
						  <td class="gboldli">&nbsp;</td>
						  <td><label>
						    <textarea name="help_reg"><?php echo stripslashes($row['help_reg']); ?></textarea>
						  </label></td>
					  </tr>
					...
					<div><strong>French</strong></div>
						...
						<tr>
						  <td class="gboldli">&nbsp;</td>
						  <td><label>
						    <textarea name="help_reg1"><?php echo stripslashes($row1['help_reg']); ?></textarea>
						  </label></td>
					  </tr>
						<tr><td class="gboldli">&nbsp;</td>
						  <td>&nbsp;</td>
					...
					<?php /*?><div><strong>Chinese</strong></div>
						...
						<tr>
						  <td class="gboldli">&nbsp;</td>
						  <td><label>
						    <textarea name="help_reg2"><?php echo stripslashes($row2['help_reg']); ?></textarea>
						  </label></td>
					  </tr>
						<tr><td class="gboldli">&nbsp;</td>
						  <td>&nbsp;</td>
					...
					<div><strong>Spanish</strong></div>
						...
						<tr>
						  <td class="gboldli">&nbsp;</td>
						  <td><label>
						    <textarea name="help_reg3"><?php echo stripslashes($row3['help_reg']); ?></textarea>
						  </label></td>
					  </tr>
						<tr><td class="gboldli">&nbsp;</td>
						  <td>&nbsp;</td>
