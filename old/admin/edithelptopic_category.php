...
//session_start();
	...
	header("Location:helptopic_category.php?added");
	}
?>
		...
		<div class="tab_container">
			...
			<table width="98%" align="left" cellspacing="0" >
				...
				<tr><td valign="top">
					...
					<table width="513" height="70" align="center" style="border:1px solid #E6E6E6;">
					  ...
					  <?php } ?>
						...
						<tr bgcolor="#E6E6E6">
						  <td colspan="4" height="20"><div align="center"><strong>Add Category</strong></div></td>
					  </tr>
						<tr>
						  <td width="53" class="gboldli">&nbsp;</td>
						  <td width="129"><a href="helptopic_category.php"></a></td>
						  <td width="200">&nbsp;</td>
						  <td width="13">&nbsp;</td>
					  </tr>
