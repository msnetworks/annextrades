...
<link href="css/core-inetdir1.css" rel="stylesheet" type="text/css" />
	...
	<section id="main" class="column">
		...
		<header><h3 class="tabs_involved">Enquiry Reply</h3>
		</header>
		<div class="tab_container">
			...
			<table width="98%" align="center" cellspacing="0" style="border:solid 1px #fff;">
				...
				<tr><td valign="top">
					...
					<tr>
						<tr><td>&nbsp;</td></tr>
						<tr><td height="35" align="center"><strong style="color:#047AB6; font-size:14px;">Successfully Sent Your Message!</strong></td></tr>
						<tr><td>&nbsp;</td></tr>
						<!--<tr><td align="center"><input type="button" name="back" value="Back" onclick="javascript:history.go(-1);"/></td></tr>-->
					</table>
				  </form>
				</td></tr>
		  </table>
