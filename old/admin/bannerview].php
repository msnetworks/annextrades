	...
	<section id="main" class="column">
		...
		<div class="tab_container">
			...
			<thead> 
				<tr> 
   					<th width="33">S.No</th> 
    				<th width="55">Product Image </th> 
					<th width="55">Product Name</th> 
					<th width="71">Orginal Rate</th>
					<th width="56">Current Rate</th>
					<th width="40">Min Order</th>
					<th width="54">Actions</th>
				</tr> 
			</thead> 
			<tbody> 
				...
				<tr>
                                ...
                                <td>
								  ...
								  <img src="<?php echo $array_in['image'];?>" width="50" height="50" />
								   <?php } else {?>
								   <img src="../images1/img_noimg.jpg" width="50" height="50" />
								   <?php }?>
								</td>
							
                                <td><?PHP echo $array_in['product_name'];?></td>
								
								<td><?PHP echo $array_in['orginal_rate'];?></td>
								<td><?PHP echo $array_in['current_rate'];?></td>
								<td><?PHP echo $array_in['minimum_order'];?></td>
								<td>
