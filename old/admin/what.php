...
session_start();
	...
	$sqlget=mysqli_query($con,"SELECT `what` FROM general");
	$sqlget1=mysqli_query($con,"SELECT `what` FROM general_french");
	//$sqlget2=mysqli_query($con,"SELECT `what` FROM general_chinese");
	$sqlget3=mysqli_query($con,"SELECT `what` FROM general_spanish");
	...
	$what1=mysqli_real_escape_string($con, $_POST['what1']);
	$what2=mysqli_real_escape_string($con, $_POST['what2']);
	$what3=mysqli_real_escape_string($con, $_POST['what3']);
		$sqll=mysqli_query($con,"SELECT what FROM general");
		$sql2=mysqli_query($con,"SELECT `what` FROM `general_french`");
	    //$sql3=mysqli_query($con,"SELECT `what` FROM `general_chinese`");
		$sql4=mysqli_query($con,"SELECT `what` FROM `general_spanish`");
	   ...
	   // $check2=mysqli_num_rows($sql3);
	    ...
	    if(($check > 0) && ($check1 > 0) && ($check3 > 0)){
			//$qry = "UPDATE general SET what = '$what'";
			$sql=mysqli_query($con,"UPDATE general SET `what`='$what'");
	        $sql=mysqli_query($con,"UPDATE general_french SET `what`='$what1'");
	        //$sql=mysqli_query($con,"UPDATE general_chinese SET `what`='$what2'");
			$sql=mysqli_query($con,"UPDATE general_spanish SET `what`='$what3'");

		}else{
			//$qry = "INSERT INTO general(what) values ('$what')";
			$sql=mysqli_query($con,"INSERT INTO general(`what`)value('$what')");
	        $sql=mysqli_query($con,"INSERT INTO general_french(`what`)value('$what1')");
	        //$sql=mysqli_query($con,"INSERT INTO general_chinese(`what`)value('$what2')");
			$sql=mysqli_query($con,"INSERT INTO general_spanish(`what`)value('$what3')");
			
		}
		//$sql=mysqli_query($con,$qry) or die(mysqli_error);
		header("Location:what.php?updated");
	}
?>
...
{
tinyMCE.triggerSave();
if(document.whatpage.what.value=="")
{
alert('Enter Content');
document.whatpage.what.focus();
return false;
}
}
	...
	<section id="main" class="column">
		...
		<header><h3 class="tabs_involved">What is B2B</h3><h2 style="padding-top:7px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:history.back(-1);" style="color:#009900;">Back</a></h2>
		</header>
		<div class="tab_container">
			...
			<table width="98%" align="left" cellspacing="0" >
				...
				<tr><td valign="top">
					<form name="whatpage" action="" method="post" onsubmit="return validation();">
					...
					<div><strong>English</strong></div>
						<tr bgcolor="#E6E6E6">
						  <td colspan="2" height="20"><div align="center"><strong>What is B2B</strong></div></td>
					  </tr>
						<tr>
						...
						<tr>
						  <td class="gboldli">&nbsp;</td>
						  <td><label>
						    <textarea name="what"><?php echo stripslashes($row['what']); ?></textarea>
						  </label></td>
					  </tr>
					...
					<div><strong>French</strong></div>
						...
						<tr>
						  <td class="gboldli">&nbsp;</td>
						  <td><label>
						    <textarea name="what1"><?php echo stripslashes($row1['what']); ?></textarea>
						  </label></td>
					  </tr>
						<tr><td class="gboldli">&nbsp;</td>
						  <td>&nbsp;</td>
					...
					<?php /*?><div><strong>Chinese</strong></div>
						...
						<tr>
						  <td class="gboldli">&nbsp;</td>
						  <td><label>
						    <textarea name="what2"><?php echo stripslashes($row2['what']); ?></textarea>
						  </label></td>
					  </tr>
						<tr><td class="gboldli">&nbsp;</td>
						  <td>&nbsp;</td>
					...
					<div><strong>Spanish</strong></div>
						...
						<tr>
						  <td class="gboldli">&nbsp;</td>
						  <td><label>
						    <textarea name="what3"><?php echo stripslashes($row3['what']); ?></textarea>
						  </label></td>
					  </tr>
						<tr><td class="gboldli">&nbsp;</td>
						  <td>&nbsp;</td>
