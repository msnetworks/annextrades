            ...
            <div class="tabs-cont" style="margin-top:0">
                <div class="left">
                    <div class="p-2" style="padding-top:0">
                        <div class="products-cate-heading"><h5><?php echo $post_selling_leads; ?></h5>
                        </div>
...
{
$select=mysqli_query($con,"select * from general");
}
else if($_SESSION['language']=='french')
{
$select=mysqli_query($con,"select * from general_french");
}
else if($_SESSION['language']=='chinese')
{
$select=mysqli_query($con,"select * from general_chinese");
}
else
{
$select=mysqli_query($con,"select * from general_spanish");
}
	//$select=mysqli_query($con,"select * from general");
	$gen=mysqli_fetch_array($select);
?>
                                <tr>
                                    <td style="padding-left:10px;"><?php echo $gen['postsellprod']; ?></td>
                                </tr>
                            </form>
                        </table>
                    </div>
