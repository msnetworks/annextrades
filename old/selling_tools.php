...
<div style="background-color:#29b1cb; height:25px; padding-top:7px;"><b style="color:#FFFFFF; margin-left:12px; font-size:14px;"><?php echo $selling_tools; ?></b></div>
<table border="0" width="100%" style="padding-left:30px; padding-top:20px;">
<form id="form1" name="form1" method="post" action="">
	<?php 
		$sel=mysqli_query($con,"select selling_tools from general");
		$msg=mysqli_fetch_array($sel);
	?>
	<tr>
		<td><div id="paddedbox"><span style="font-size:12px"><?php echo $msg['selling_tools']; ?></span></div></td>
	</tr>
</form>
</table>
</div>
