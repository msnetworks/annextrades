...
if(isset($_REQUEST['id']))
		{
			...
			$delete = mysqli_query($con,"update `buyingleads` set trash='1' where `buy_id` = '$selected' and id='$session_user'");
...
{
 $imgpath3 = "upload/".$fetch_buy1['photo'];	
 $id = $fetch_buy1['user_id'];
$seller_id = $fetch_buy1['seller_id'];
$da = $fetch_buy1['seller_updated_date'];
 
if(($fetch_buy1['photo'] != '') && (file_exists($imgpath3)))
{
  $image3="upload/".$fetch_buy1['photo'];
}else{
  $image3="blog_photo_thumbnail/profile_pic_small.gif";
}
...
<td width="150"><img src="<?php echo $image3;  ?>" width="80" height="80" /></td>
...
<td width="100" ><strong style="padding-bottom:5px;"><a href="buying_view.php?id=<?php echo $fetch_buy1['buy_id']; ?>"><span style=" padding-bottom:5px;"><?php echo $action; ?></span></a></strong> &nbsp;| &nbsp;<span style="padding-top:5px;"><!--<a onClick="return delete_buy('<?php echo $fetch_buy['buy_id']; ?>','<?php echo $page; ?>');">--><a onClick="return delete_new('<?php echo $fetch_buy1['buy_id']; ?>','<?php echo $page; ?>');"><img src="images/close1.png" width="20" height="20" style="padding-top:5px;"  /></a></span></td>
</tr>
</table>
<?php } } else { ?>
